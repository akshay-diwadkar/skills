...
Read only the example matching the current branch. Each fenced report validates against the same-named fixture under `tests/skills/optimize-codebase/evals/fixtures/`.
