# Diagram Codebase Question Framework
...
- [ ] Generated HTML will be built with `/path/to/diagram-codebase/scripts/build_diagram.py` and validated with `/path/to/diagram-codebase/scripts/validate_diagram.py`.
