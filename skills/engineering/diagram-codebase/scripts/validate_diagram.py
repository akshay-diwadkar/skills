...
INLINE_STYLE_RE = re.compile(
    r'<style\s+id="diagram-codebase-style"\s+data-inline-asset="css/style.css">.*?</style>',
    re.DOTALL,
)
INLINE_ROUGHJS_RE = re.compile(
    r'<script\s+id="diagram-codebase-roughjs"\s+data-inline-asset="roughjs.js">.*?</script>',
    re.DOTALL,
)
