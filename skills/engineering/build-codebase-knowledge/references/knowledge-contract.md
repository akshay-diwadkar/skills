...
## 1. Primary Rule
Source code is always authoritative. Generated machine artifacts (`repo-map.json`, `symbols.json`, `relationships.json`, `manifest.json`) are navigation indexes and query aids. Agents MUST verify implementation details in primary source files before taking action.
