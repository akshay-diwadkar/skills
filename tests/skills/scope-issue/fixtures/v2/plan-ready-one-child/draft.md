...
## Selection Stage
- CAND-1: candidate: #209 | readiness: ready | basis: snapshot open, no blockers, local ownership in F-1
- CAND-2: candidate: #210 | readiness: blocked | basis: snapshot #210 shows a review dependency not merged
- SEL-1: selected: #209 | rationale: task targets consistent normalization; #209 is the only ready child and unblocks the CLI follow-up | alternatives: #210 why-not-now: blocked on review dependency
