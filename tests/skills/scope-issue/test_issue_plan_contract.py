...
SCRIPTS_DIR = REPO_ROOT / "skills" / "engineering" / "scope-issue" / "scripts"
SENIOR_DEV_SCRIPTS = REPO_ROOT / "skills" / "engineering" / "implement-plan" / "scripts"
...
## Senior Handoff
Offer this source-bound artifact to `$plan-change` and require source markers.
"""
    ...
    def test_one_issue_scaffold_contains_untrusted_claims_and_handoff(self):
        ...
        self.assertIn("$plan-change", text)
