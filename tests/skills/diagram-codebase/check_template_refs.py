...
DEFAULT_TEMPLATE = REPO_ROOT / "skills" / "engineering" / "diagram-codebase" / "assets" / "html-diagram-template.html"
...
def main():
    ...
    if issues:
        ...
        print("in tests/skills/diagram-codebase/check_template_refs.py if it's a valid external reference.")
        sys.exit(1)
    else:
