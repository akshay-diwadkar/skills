...
ROOT = REPO_ROOT / "skills" / "engineering" / "diagram-codebase"
...
class DiagramToolTests(unittest.TestCase):
    ...
    def test_builder_inlines_runtime_assets(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('id="diagram-codebase-style" data-inline-asset="css/style.css"', text)
            self.assertIn('id="diagram-codebase-roughjs" data-inline-asset="roughjs.js"', text)
