...
## Implementation
CH-1: path: pyproject.toml | anchor: requests | status: existing | evidence: F-1 | depends_on: none | change: move the requests pin to the supported minor release | locality: local | reversibility: reversible
CH-2: path: src/requester.py | anchor: requests | status: existing | evidence: F-2 | depends_on: CH-1 | change: adapt the requester call to the compatibility behavior of the new release | locality: local | reversibility: reversible
