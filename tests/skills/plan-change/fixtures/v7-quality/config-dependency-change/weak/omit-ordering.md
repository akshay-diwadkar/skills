...
CH-2: path: src/requester.py | anchor: requests | status: existing | evidence: F-2 | depends_on: none | change: adapt the requester call to the compatibility behavior of the new release | locality: local | reversibility: reversible | propagation: local
