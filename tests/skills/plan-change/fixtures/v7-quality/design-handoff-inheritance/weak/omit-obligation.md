...
## Obligations
RQ-1: source: handoff | anchor: introduce a repository cache facade | obligation: every repository caller must invalidate through the facade | covered_by: SC-1, CH-1
