...
## Verification
T-1: covers: SC-1, CH-1 | given: absent and present input cases | when: the targeted target tests execute | then: the test suite runs without failures | command: python -m pytest tests/test_target.py -q
