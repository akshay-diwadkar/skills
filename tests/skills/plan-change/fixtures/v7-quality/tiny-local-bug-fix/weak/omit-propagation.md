...
## Implementation
CH-1: path: src/target.py | anchor: target | status: existing | evidence: F-1 | depends_on: none | change: return the empty string for absent values before stripping present names | locality: local | reversibility: reversible
