...
F-2: kind: source | path: src/handwritten.py | lines: 1-2 | anchor: handwritten | claim: handwritten normalization is the manual fallback

## Implementation
CH-1: path: src/generated_names.py | anchor: generated names output | status: new | owner: F-2 | depends_on: none | change: generate an adapter module that delegates to the handwritten normalizer | locality: local | reversibility: reversible
