...
## Verification
T-1: covers: SC-1, CH-1 | given: a clean generated output | when: the generator and targeted tests execute | then: the suite executes and reports a passing result | command: python tools/gen_names.py && python -m pytest tests/test_names.py -q
