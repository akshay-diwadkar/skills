...
## Verification
T-1: covers: SC-1, CH-1, CH-2 | given: consumer and re-export callers | when: the targeted refactor tests execute | then: the suite executes and reports a passing result | command: python -m pytest tests/test_refactor.py -q
