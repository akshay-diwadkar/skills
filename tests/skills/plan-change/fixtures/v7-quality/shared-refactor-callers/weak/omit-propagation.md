...
## Propagation
P-1: surface: consumer | disposition: changed | path: src/consumer_b.py | owner: CH-1 | reason: F-1
P-2: surface: consumer | disposition: changed | path: src/consumer_b.py | owner: CH-1 | reason: F-1
