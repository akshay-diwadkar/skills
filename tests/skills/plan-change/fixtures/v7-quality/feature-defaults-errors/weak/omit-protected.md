...
## Outcome
SC-1: given: missing or invalid shipping input | when: place_order resolves the shipping mode | then: missing input falls back to standard and invalid input is rejected | unchanged: the checkout badge stays warm
