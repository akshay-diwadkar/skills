...
SCRIPT_PATH = REPO_ROOT / "skills" / "engineering" / "codebase-issue-auditor" / "scripts" / "check_github_env.py"
SKILL_PATH = REPO_ROOT / "skills" / "engineering" / "codebase-issue-auditor" / "SKILL.md"
