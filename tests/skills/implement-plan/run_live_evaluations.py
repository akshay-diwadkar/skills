...
SKILL_PATH = REPO_ROOT / "skills" / "engineering" / "implement-plan"
...
def run_case(
    ...
    with tempfile.TemporaryDirectory(prefix=f"implement-eval-{case_id}-") as temporary:
        ...
        bundle_path = fixture / ".scratch" / "implement-plan" / "eval" / "implementation.json"
        request = {
            "case_id": case_id,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=REPO_ROOT / ".scratch" / "implement-plan-evals")
