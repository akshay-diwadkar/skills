...
## Obligations
RQ-1: source: request | anchor: JavaScript delegation | obligation: preserve direct callee delegation during reorganization | covered_by: SC-1, CH-1, T-1
...
## Implementation
CH-1: path: src/names.js | anchor: caller | status: existing | evidence: F-1 | change: preserve direct callee delegation while reorganizing the surrounding module implementation | depends_on: none | locality: local | reversibility: reversible
