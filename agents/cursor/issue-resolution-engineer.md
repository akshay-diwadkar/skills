---
name: issue-resolution-engineer
description: Inspect GitHub issues, reconcile issue claims with local checkout, and plan or implement authorized fixes.
model: inherit
readonly: false
---
<!-- Generated from catalog/agents.yaml and agents/source/issue-resolution-engineer.md. Do not edit directly. -->
