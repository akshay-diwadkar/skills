...
regeneration check, and temporary materialization all consume that inventory.
Git preserves the generated bytes without checkout newline conversion; hashing
never normalizes content. Centrally recognized runtime cache directories are
outside fixture identity and are never materialized.
