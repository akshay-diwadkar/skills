...
pub fn controlplane_export_enterprise_atlantic_operator_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1600".into());
    Ok(signal)
}
