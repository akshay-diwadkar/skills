...
pub fn processors_transform_industrial_southern_catalog_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1789".into());
    Ok(signal)
}
