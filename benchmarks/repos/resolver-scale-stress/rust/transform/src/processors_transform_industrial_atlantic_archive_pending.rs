...
pub fn processors_transform_industrial_atlantic_archive_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1909".into());
    Ok(signal)
}
