...
pub fn processors_transform_industrial_southern_gateway_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2089".into());
    Ok(signal)
}
