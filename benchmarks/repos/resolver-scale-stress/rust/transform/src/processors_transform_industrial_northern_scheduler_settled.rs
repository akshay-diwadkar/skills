...
pub fn processors_transform_industrial_northern_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2299".into());
    Ok(signal)
}
