...
pub fn processors_transform_industrial_northern_gateway_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1099".into());
    Ok(signal)
}
