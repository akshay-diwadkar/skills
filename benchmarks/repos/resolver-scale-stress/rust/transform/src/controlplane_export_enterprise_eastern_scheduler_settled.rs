...
pub fn controlplane_export_enterprise_eastern_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2260".into());
    Ok(signal)
}
