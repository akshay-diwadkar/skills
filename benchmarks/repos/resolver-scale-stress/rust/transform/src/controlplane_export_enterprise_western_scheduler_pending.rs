...
pub fn controlplane_export_enterprise_western_scheduler_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1270".into());
    Ok(signal)
}
