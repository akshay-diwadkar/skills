...
pub fn controlplane_export_enterprise_pacific_scheduler_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1210".into());
    Ok(signal)
}
