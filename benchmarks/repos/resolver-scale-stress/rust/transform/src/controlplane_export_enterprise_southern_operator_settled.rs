...
pub fn controlplane_export_enterprise_southern_operator_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2680".into());
    Ok(signal)
}
