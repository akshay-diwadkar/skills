...
pub fn controlplane_export_enterprise_coastal_scheduler_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1240".into());
    Ok(signal)
}
