...
pub fn processors_transform_industrial_southern_scheduler_active(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "289".into());
    Ok(signal)
}
