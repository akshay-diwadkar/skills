...
pub fn processors_transform_industrial_southern_operator_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2689".into());
    Ok(signal)
}
