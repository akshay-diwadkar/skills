...
pub fn processors_transform_industrial_eastern_operator_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1669".into());
    Ok(signal)
}
