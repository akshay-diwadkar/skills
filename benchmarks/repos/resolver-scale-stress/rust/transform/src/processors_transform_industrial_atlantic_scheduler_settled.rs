...
pub fn processors_transform_industrial_atlantic_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2209".into());
    Ok(signal)
}
