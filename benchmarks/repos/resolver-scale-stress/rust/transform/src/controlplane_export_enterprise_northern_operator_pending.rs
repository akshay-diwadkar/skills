...
pub fn controlplane_export_enterprise_northern_operator_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1690".into());
    Ok(signal)
}
