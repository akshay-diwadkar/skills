...
pub fn processors_transform_industrial_southern_console_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1189".into());
    Ok(signal)
}
