...
pub fn processors_transform_industrial_eastern_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2269".into());
    Ok(signal)
}
