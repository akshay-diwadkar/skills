...
pub fn controlplane_export_enterprise_atlantic_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2200".into());
    Ok(signal)
}
