...
pub fn processors_transform_industrial_southern_archive_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2989".into());
    Ok(signal)
}
