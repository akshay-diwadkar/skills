...
pub fn controlplane_export_enterprise_northern_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2290".into());
    Ok(signal)
}
