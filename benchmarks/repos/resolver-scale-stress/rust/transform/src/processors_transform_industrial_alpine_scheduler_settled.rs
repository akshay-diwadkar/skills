...
pub fn processors_transform_industrial_alpine_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2239".into());
    Ok(signal)
}
