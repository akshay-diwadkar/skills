...
pub fn processors_transform_industrial_northern_webhook_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2599".into());
    Ok(signal)
}
