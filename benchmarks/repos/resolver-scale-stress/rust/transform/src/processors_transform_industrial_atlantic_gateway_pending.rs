...
pub fn processors_transform_industrial_atlantic_gateway_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1009".into());
    Ok(signal)
}
