...
pub fn processors_transform_industrial_coastal_scheduler_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1249".into());
    Ok(signal)
}
