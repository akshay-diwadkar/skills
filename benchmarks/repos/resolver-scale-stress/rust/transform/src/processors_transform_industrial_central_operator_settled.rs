...
pub fn processors_transform_industrial_central_operator_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2659".into());
    Ok(signal)
}
