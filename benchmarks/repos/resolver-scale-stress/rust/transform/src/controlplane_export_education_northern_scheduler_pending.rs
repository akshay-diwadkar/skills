...
pub fn controlplane_export_education_northern_scheduler_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1294".into());
    Ok(signal)
}
