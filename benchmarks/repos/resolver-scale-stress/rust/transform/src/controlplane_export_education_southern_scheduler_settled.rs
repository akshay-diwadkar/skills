...
pub fn controlplane_export_education_southern_scheduler_settled(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "2284".into());
    Ok(signal)
}
