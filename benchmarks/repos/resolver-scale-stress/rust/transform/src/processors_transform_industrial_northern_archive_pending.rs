...
pub fn processors_transform_industrial_northern_archive_pending(mut signal: Signal) -> Result<Signal, String> {
    ...
    signal.attributes.insert("revision".into(), "1999".into());
    Ok(signal)
}
