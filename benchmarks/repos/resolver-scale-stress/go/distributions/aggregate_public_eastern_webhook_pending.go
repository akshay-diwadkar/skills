...
// AggregatePublicEasternWebhookPending validates and enriches one telemetry component configuration.
func AggregatePublicEasternWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1563"
    return input, nil
}
