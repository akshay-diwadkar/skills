...
// AggregateIndustrialSouthernGatewayPending validates and enriches one telemetry component configuration.
func AggregateIndustrialSouthernGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1089"
    return input, nil
}
