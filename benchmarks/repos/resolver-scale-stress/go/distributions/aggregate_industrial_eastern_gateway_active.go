...
// AggregateIndustrialEasternGatewayActive validates and enriches one telemetry component configuration.
func AggregateIndustrialEasternGatewayActive(input shared.Component) (shared.Component, error) {
