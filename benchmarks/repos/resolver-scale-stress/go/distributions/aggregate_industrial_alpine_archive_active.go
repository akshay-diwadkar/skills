...
// AggregateIndustrialAlpineArchiveActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAlpineArchiveActive(input shared.Component) (shared.Component, error) {
