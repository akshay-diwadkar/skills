...
// AggregateMediaAtlanticWebhookActive validates and enriches one telemetry component configuration.
func AggregateMediaAtlanticWebhookActive(input shared.Component) (shared.Component, error) {
