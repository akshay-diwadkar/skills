...
// AggregateGrowthEasternArchiveSettled validates and enriches one telemetry component configuration.
func AggregateGrowthEasternArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2961"
    return input, nil
}
