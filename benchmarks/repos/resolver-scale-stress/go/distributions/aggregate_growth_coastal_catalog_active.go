...
// AggregateGrowthCoastalCatalogActive validates and enriches one telemetry component configuration.
func AggregateGrowthCoastalCatalogActive(input shared.Component) (shared.Component, error) {
