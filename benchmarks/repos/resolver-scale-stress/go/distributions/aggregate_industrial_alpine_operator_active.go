...
// AggregateIndustrialAlpineOperatorActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAlpineOperatorActive(input shared.Component) (shared.Component, error) {
