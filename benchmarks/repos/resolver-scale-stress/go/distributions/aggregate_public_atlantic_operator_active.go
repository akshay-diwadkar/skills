...
// AggregatePublicAtlanticOperatorActive validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticOperatorActive(input shared.Component) (shared.Component, error) {
