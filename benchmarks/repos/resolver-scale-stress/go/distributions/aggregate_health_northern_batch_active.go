...
// AggregateHealthNorthernBatchActive validates and enriches one telemetry component configuration.
func AggregateHealthNorthernBatchActive(input shared.Component) (shared.Component, error) {
