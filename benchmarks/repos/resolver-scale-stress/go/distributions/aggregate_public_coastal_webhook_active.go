...
// AggregatePublicCoastalWebhookActive validates and enriches one telemetry component configuration.
func AggregatePublicCoastalWebhookActive(input shared.Component) (shared.Component, error) {
