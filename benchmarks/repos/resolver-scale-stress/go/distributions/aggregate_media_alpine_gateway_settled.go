...
// AggregateMediaAlpineGatewaySettled validates and enriches one telemetry component configuration.
func AggregateMediaAlpineGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2037"
    return input, nil
}
