...
// AggregateMediaNordicOperatorActive validates and enriches one telemetry component configuration.
func AggregateMediaNordicOperatorActive(input shared.Component) (shared.Component, error) {
