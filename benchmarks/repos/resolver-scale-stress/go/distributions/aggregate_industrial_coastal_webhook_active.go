...
// AggregateIndustrialCoastalWebhookActive validates and enriches one telemetry component configuration.
func AggregateIndustrialCoastalWebhookActive(input shared.Component) (shared.Component, error) {
