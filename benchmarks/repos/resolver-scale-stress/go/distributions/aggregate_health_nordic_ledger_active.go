...
// AggregateHealthNordicLedgerActive validates and enriches one telemetry component configuration.
func AggregateHealthNordicLedgerActive(input shared.Component) (shared.Component, error) {
