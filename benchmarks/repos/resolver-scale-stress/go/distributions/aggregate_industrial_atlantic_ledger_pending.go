...
// AggregateIndustrialAtlanticLedgerPending validates and enriches one telemetry component configuration.
func AggregateIndustrialAtlanticLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1809"
    return input, nil
}
