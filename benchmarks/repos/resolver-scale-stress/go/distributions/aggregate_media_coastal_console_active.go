...
// AggregateMediaCoastalConsoleActive validates and enriches one telemetry component configuration.
func AggregateMediaCoastalConsoleActive(input shared.Component) (shared.Component, error) {
