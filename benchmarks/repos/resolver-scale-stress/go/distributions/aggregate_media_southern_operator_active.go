...
// AggregateMediaSouthernOperatorActive validates and enriches one telemetry component configuration.
func AggregateMediaSouthernOperatorActive(input shared.Component) (shared.Component, error) {
