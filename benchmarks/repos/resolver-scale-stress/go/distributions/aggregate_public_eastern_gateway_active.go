...
// AggregatePublicEasternGatewayActive validates and enriches one telemetry component configuration.
func AggregatePublicEasternGatewayActive(input shared.Component) (shared.Component, error) {
