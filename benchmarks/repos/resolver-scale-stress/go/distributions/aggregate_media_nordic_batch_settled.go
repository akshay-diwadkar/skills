...
// AggregateMediaNordicBatchSettled validates and enriches one telemetry component configuration.
func AggregateMediaNordicBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2427"
    return input, nil
}
