...
// AggregateIndustrialAlpineWebhookPending validates and enriches one telemetry component configuration.
func AggregateIndustrialAlpineWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1539"
    return input, nil
}
