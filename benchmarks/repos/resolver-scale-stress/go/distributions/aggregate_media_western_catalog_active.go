...
// AggregateMediaWesternCatalogActive validates and enriches one telemetry component configuration.
func AggregateMediaWesternCatalogActive(input shared.Component) (shared.Component, error) {
