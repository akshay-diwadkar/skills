...
// AggregateMediaNorthernBatchPending validates and enriches one telemetry component configuration.
func AggregateMediaNorthernBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1497"
    return input, nil
}
