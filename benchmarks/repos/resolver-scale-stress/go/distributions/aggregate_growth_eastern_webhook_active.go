...
// AggregateGrowthEasternWebhookActive validates and enriches one telemetry component configuration.
func AggregateGrowthEasternWebhookActive(input shared.Component) (shared.Component, error) {
