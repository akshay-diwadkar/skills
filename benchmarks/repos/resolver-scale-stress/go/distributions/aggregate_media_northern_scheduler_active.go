...
// AggregateMediaNorthernSchedulerActive validates and enriches one telemetry component configuration.
func AggregateMediaNorthernSchedulerActive(input shared.Component) (shared.Component, error) {
