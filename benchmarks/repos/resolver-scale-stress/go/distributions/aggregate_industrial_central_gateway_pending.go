...
// AggregateIndustrialCentralGatewayPending validates and enriches one telemetry component configuration.
func AggregateIndustrialCentralGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1059"
    return input, nil
}
