...
// AggregatePublicEasternLedgerPending validates and enriches one telemetry component configuration.
func AggregatePublicEasternLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1863"
    return input, nil
}
