...
// AggregateIndustrialSouthernCatalogActive validates and enriches one telemetry component configuration.
func AggregateIndustrialSouthernCatalogActive(input shared.Component) (shared.Component, error) {
