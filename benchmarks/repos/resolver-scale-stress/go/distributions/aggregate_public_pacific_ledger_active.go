...
// AggregatePublicPacificLedgerActive validates and enriches one telemetry component configuration.
func AggregatePublicPacificLedgerActive(input shared.Component) (shared.Component, error) {
