...
// AggregateHealthSouthernWebhookActive validates and enriches one telemetry component configuration.
func AggregateHealthSouthernWebhookActive(input shared.Component) (shared.Component, error) {
