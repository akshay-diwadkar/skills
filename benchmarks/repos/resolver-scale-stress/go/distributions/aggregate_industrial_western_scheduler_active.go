...
// AggregateIndustrialWesternSchedulerActive validates and enriches one telemetry component configuration.
func AggregateIndustrialWesternSchedulerActive(input shared.Component) (shared.Component, error) {
