...
// AggregatePublicAtlanticLedgerPending validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1803"
    return input, nil
}
