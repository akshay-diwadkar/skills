...
// AggregateHealthCentralWebhookActive validates and enriches one telemetry component configuration.
func AggregateHealthCentralWebhookActive(input shared.Component) (shared.Component, error) {
