...
// AggregateMediaCoastalWebhookSettled validates and enriches one telemetry component configuration.
func AggregateMediaCoastalWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2547"
    return input, nil
}
