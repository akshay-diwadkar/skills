...
// AggregatePublicAtlanticStreamActive validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticStreamActive(input shared.Component) (shared.Component, error) {
