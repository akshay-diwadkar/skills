...
// AggregateIndustrialCentralBatchActive validates and enriches one telemetry component configuration.
func AggregateIndustrialCentralBatchActive(input shared.Component) (shared.Component, error) {
