...
// AggregatePublicWesternLedgerActive validates and enriches one telemetry component configuration.
func AggregatePublicWesternLedgerActive(input shared.Component) (shared.Component, error) {
