...
// AggregateIndustrialCentralCatalogActive validates and enriches one telemetry component configuration.
func AggregateIndustrialCentralCatalogActive(input shared.Component) (shared.Component, error) {
