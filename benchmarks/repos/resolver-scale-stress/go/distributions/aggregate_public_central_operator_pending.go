...
// AggregatePublicCentralOperatorPending validates and enriches one telemetry component configuration.
func AggregatePublicCentralOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1653"
    return input, nil
}
