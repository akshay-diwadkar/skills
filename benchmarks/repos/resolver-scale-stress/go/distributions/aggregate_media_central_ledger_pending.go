...
// AggregateMediaCentralLedgerPending validates and enriches one telemetry component configuration.
func AggregateMediaCentralLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1857"
    return input, nil
}
