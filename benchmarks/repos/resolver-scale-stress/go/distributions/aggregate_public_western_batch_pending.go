...
// AggregatePublicWesternBatchPending validates and enriches one telemetry component configuration.
func AggregatePublicWesternBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1473"
    return input, nil
}
