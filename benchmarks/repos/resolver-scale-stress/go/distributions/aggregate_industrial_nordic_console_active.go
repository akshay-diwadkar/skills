...
// AggregateIndustrialNordicConsoleActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNordicConsoleActive(input shared.Component) (shared.Component, error) {
