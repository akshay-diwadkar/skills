...
// AggregateGrowthNordicStreamActive validates and enriches one telemetry component configuration.
func AggregateGrowthNordicStreamActive(input shared.Component) (shared.Component, error) {
