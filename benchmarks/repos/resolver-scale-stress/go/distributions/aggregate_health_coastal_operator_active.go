...
// AggregateHealthCoastalOperatorActive validates and enriches one telemetry component configuration.
func AggregateHealthCoastalOperatorActive(input shared.Component) (shared.Component, error) {
