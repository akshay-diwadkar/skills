...
// AggregatePublicEasternBatchSettled validates and enriches one telemetry component configuration.
func AggregatePublicEasternBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2463"
    return input, nil
}
