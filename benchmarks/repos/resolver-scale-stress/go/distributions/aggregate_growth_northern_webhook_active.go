...
// AggregateGrowthNorthernWebhookActive validates and enriches one telemetry component configuration.
func AggregateGrowthNorthernWebhookActive(input shared.Component) (shared.Component, error) {
