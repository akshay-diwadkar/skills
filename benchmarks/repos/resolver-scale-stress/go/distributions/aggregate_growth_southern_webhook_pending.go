...
// AggregateGrowthSouthernWebhookPending validates and enriches one telemetry component configuration.
func AggregateGrowthSouthernWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1581"
    return input, nil
}
