...
// AggregatePublicSouthernSchedulerSettled validates and enriches one telemetry component configuration.
func AggregatePublicSouthernSchedulerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2283"
    return input, nil
}
