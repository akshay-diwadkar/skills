...
// AggregateHealthPacificArchiveActive validates and enriches one telemetry component configuration.
func AggregateHealthPacificArchiveActive(input shared.Component) (shared.Component, error) {
