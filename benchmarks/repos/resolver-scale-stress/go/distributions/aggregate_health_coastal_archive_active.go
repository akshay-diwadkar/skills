...
// AggregateHealthCoastalArchiveActive validates and enriches one telemetry component configuration.
func AggregateHealthCoastalArchiveActive(input shared.Component) (shared.Component, error) {
