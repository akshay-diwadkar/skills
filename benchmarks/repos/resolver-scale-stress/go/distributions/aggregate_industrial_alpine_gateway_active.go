...
// AggregateIndustrialAlpineGatewayActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAlpineGatewayActive(input shared.Component) (shared.Component, error) {
