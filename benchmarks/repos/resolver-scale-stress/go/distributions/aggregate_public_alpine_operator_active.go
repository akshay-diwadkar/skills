...
// AggregatePublicAlpineOperatorActive validates and enriches one telemetry component configuration.
func AggregatePublicAlpineOperatorActive(input shared.Component) (shared.Component, error) {
