...
// AggregateHealthAlpineConsoleActive validates and enriches one telemetry component configuration.
func AggregateHealthAlpineConsoleActive(input shared.Component) (shared.Component, error) {
