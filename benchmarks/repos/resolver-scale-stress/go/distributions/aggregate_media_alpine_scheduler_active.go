...
// AggregateMediaAlpineSchedulerActive validates and enriches one telemetry component configuration.
func AggregateMediaAlpineSchedulerActive(input shared.Component) (shared.Component, error) {
