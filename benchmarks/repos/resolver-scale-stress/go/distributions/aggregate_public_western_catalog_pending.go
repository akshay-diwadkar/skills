...
// AggregatePublicWesternCatalogPending validates and enriches one telemetry component configuration.
func AggregatePublicWesternCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1773"
    return input, nil
}
