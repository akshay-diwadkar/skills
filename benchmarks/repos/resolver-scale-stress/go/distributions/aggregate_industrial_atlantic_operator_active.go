...
// AggregateIndustrialAtlanticOperatorActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAtlanticOperatorActive(input shared.Component) (shared.Component, error) {
