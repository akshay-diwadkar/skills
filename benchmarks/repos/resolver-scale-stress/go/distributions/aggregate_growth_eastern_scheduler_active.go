...
// AggregateGrowthEasternSchedulerActive validates and enriches one telemetry component configuration.
func AggregateGrowthEasternSchedulerActive(input shared.Component) (shared.Component, error) {
