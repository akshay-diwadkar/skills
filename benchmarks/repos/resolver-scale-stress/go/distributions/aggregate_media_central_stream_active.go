...
// AggregateMediaCentralStreamActive validates and enriches one telemetry component configuration.
func AggregateMediaCentralStreamActive(input shared.Component) (shared.Component, error) {
