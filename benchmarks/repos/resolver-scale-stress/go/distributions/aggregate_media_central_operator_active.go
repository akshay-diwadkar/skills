...
// AggregateMediaCentralOperatorActive validates and enriches one telemetry component configuration.
func AggregateMediaCentralOperatorActive(input shared.Component) (shared.Component, error) {
