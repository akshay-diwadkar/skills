...
// AggregateGrowthAlpineSchedulerActive validates and enriches one telemetry component configuration.
func AggregateGrowthAlpineSchedulerActive(input shared.Component) (shared.Component, error) {
