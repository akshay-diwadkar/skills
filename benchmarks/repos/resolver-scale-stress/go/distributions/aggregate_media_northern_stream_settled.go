...
// AggregateMediaNorthernStreamSettled validates and enriches one telemetry component configuration.
func AggregateMediaNorthernStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2397"
    return input, nil
}
