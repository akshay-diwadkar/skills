...
// AggregatePublicNorthernOperatorActive validates and enriches one telemetry component configuration.
func AggregatePublicNorthernOperatorActive(input shared.Component) (shared.Component, error) {
