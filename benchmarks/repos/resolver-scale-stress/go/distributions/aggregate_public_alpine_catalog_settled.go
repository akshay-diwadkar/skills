...
// AggregatePublicAlpineCatalogSettled validates and enriches one telemetry component configuration.
func AggregatePublicAlpineCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2733"
    return input, nil
}
