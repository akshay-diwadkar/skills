...
// AggregatePublicSouthernLedgerSettled validates and enriches one telemetry component configuration.
func AggregatePublicSouthernLedgerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2883"
    return input, nil
}
