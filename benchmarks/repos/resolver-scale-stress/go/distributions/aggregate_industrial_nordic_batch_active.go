...
// AggregateIndustrialNordicBatchActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNordicBatchActive(input shared.Component) (shared.Component, error) {
