...
// AggregateIndustrialWesternGatewaySettled validates and enriches one telemetry component configuration.
func AggregateIndustrialWesternGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2079"
    return input, nil
}
