...
// AggregateHealthWesternOperatorActive validates and enriches one telemetry component configuration.
func AggregateHealthWesternOperatorActive(input shared.Component) (shared.Component, error) {
