...
// AggregateHealthAlpineBatchActive validates and enriches one telemetry component configuration.
func AggregateHealthAlpineBatchActive(input shared.Component) (shared.Component, error) {
