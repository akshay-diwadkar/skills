...
// AggregateGrowthNordicLedgerPending validates and enriches one telemetry component configuration.
func AggregateGrowthNordicLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1821"
    return input, nil
}
