...
// AggregatePublicNorthernGatewayActive validates and enriches one telemetry component configuration.
func AggregatePublicNorthernGatewayActive(input shared.Component) (shared.Component, error) {
