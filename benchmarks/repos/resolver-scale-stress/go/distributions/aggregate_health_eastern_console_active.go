...
// AggregateHealthEasternConsoleActive validates and enriches one telemetry component configuration.
func AggregateHealthEasternConsoleActive(input shared.Component) (shared.Component, error) {
