...
// AggregateMediaNorthernArchiveSettled validates and enriches one telemetry component configuration.
func AggregateMediaNorthernArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2997"
    return input, nil
}
