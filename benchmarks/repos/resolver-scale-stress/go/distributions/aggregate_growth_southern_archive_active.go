...
// AggregateGrowthSouthernArchiveActive validates and enriches one telemetry component configuration.
func AggregateGrowthSouthernArchiveActive(input shared.Component) (shared.Component, error) {
