...
// AggregatePublicCentralBatchActive validates and enriches one telemetry component configuration.
func AggregatePublicCentralBatchActive(input shared.Component) (shared.Component, error) {
