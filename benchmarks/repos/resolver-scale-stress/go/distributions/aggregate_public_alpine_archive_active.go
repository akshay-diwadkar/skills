...
// AggregatePublicAlpineArchiveActive validates and enriches one telemetry component configuration.
func AggregatePublicAlpineArchiveActive(input shared.Component) (shared.Component, error) {
