...
// AggregatePublicSouthernBatchActive validates and enriches one telemetry component configuration.
func AggregatePublicSouthernBatchActive(input shared.Component) (shared.Component, error) {
