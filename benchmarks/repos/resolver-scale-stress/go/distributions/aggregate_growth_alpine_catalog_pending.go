...
// AggregateGrowthAlpineCatalogPending validates and enriches one telemetry component configuration.
func AggregateGrowthAlpineCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1731"
    return input, nil
}
