...
// AggregatePublicCentralGatewayPending validates and enriches one telemetry component configuration.
func AggregatePublicCentralGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1053"
    return input, nil
}
