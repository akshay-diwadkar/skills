...
// AggregateIndustrialNordicCatalogActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNordicCatalogActive(input shared.Component) (shared.Component, error) {
