...
// AggregateGrowthNorthernOperatorSettled validates and enriches one telemetry component configuration.
func AggregateGrowthNorthernOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2691"
    return input, nil
}
