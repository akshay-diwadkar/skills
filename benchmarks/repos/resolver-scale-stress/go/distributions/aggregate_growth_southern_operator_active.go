...
// AggregateGrowthSouthernOperatorActive validates and enriches one telemetry component configuration.
func AggregateGrowthSouthernOperatorActive(input shared.Component) (shared.Component, error) {
