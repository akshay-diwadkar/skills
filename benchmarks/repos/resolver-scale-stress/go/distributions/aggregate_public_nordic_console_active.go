...
// AggregatePublicNordicConsoleActive validates and enriches one telemetry component configuration.
func AggregatePublicNordicConsoleActive(input shared.Component) (shared.Component, error) {
