...
// AggregateGrowthWesternWebhookSettled validates and enriches one telemetry component configuration.
func AggregateGrowthWesternWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2571"
    return input, nil
}
