...
// AggregateMediaNorthernLedgerActive validates and enriches one telemetry component configuration.
func AggregateMediaNorthernLedgerActive(input shared.Component) (shared.Component, error) {
