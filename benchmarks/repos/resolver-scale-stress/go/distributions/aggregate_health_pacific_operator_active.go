...
// AggregateHealthPacificOperatorActive validates and enriches one telemetry component configuration.
func AggregateHealthPacificOperatorActive(input shared.Component) (shared.Component, error) {
