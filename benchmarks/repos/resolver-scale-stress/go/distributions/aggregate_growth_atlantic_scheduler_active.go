...
// AggregateGrowthAtlanticSchedulerActive validates and enriches one telemetry component configuration.
func AggregateGrowthAtlanticSchedulerActive(input shared.Component) (shared.Component, error) {
