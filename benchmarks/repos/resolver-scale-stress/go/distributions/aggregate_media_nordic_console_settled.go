...
// AggregateMediaNordicConsoleSettled validates and enriches one telemetry component configuration.
func AggregateMediaNordicConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2127"
    return input, nil
}
