...
// AggregateMediaPacificConsoleActive validates and enriches one telemetry component configuration.
func AggregateMediaPacificConsoleActive(input shared.Component) (shared.Component, error) {
