...
// AggregateIndustrialNorthernConsoleSettled validates and enriches one telemetry component configuration.
func AggregateIndustrialNorthernConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2199"
    return input, nil
}
