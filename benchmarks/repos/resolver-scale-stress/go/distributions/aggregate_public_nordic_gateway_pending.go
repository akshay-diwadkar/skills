...
// AggregatePublicNordicGatewayPending validates and enriches one telemetry component configuration.
func AggregatePublicNordicGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1023"
    return input, nil
}
