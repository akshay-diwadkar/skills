...
// AggregatePublicAlpineGatewayActive validates and enriches one telemetry component configuration.
func AggregatePublicAlpineGatewayActive(input shared.Component) (shared.Component, error) {
