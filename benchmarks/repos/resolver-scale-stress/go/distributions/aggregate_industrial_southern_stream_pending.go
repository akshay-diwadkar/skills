...
// AggregateIndustrialSouthernStreamPending validates and enriches one telemetry component configuration.
func AggregateIndustrialSouthernStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1389"
    return input, nil
}
