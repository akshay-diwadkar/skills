...
// AggregateMediaAlpineArchiveSettled validates and enriches one telemetry component configuration.
func AggregateMediaAlpineArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2937"
    return input, nil
}
