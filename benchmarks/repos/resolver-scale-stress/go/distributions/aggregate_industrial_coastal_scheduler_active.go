...
// AggregateIndustrialCoastalSchedulerActive validates and enriches one telemetry component configuration.
func AggregateIndustrialCoastalSchedulerActive(input shared.Component) (shared.Component, error) {
