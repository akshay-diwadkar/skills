...
// AggregateMediaEasternStreamSettled validates and enriches one telemetry component configuration.
func AggregateMediaEasternStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2367"
    return input, nil
}
