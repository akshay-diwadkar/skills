...
// AggregateIndustrialNorthernLedgerPending validates and enriches one telemetry component configuration.
func AggregateIndustrialNorthernLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1899"
    return input, nil
}
