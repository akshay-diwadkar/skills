...
// AggregateGrowthCentralGatewayActive validates and enriches one telemetry component configuration.
func AggregateGrowthCentralGatewayActive(input shared.Component) (shared.Component, error) {
