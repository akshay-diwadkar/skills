...
// AggregateMediaNordicGatewayActive validates and enriches one telemetry component configuration.
func AggregateMediaNordicGatewayActive(input shared.Component) (shared.Component, error) {
