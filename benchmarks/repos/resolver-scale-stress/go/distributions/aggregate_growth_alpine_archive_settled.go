...
// AggregateGrowthAlpineArchiveSettled validates and enriches one telemetry component configuration.
func AggregateGrowthAlpineArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2931"
    return input, nil
}
