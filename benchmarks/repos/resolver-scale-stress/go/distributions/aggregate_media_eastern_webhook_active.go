...
// AggregateMediaEasternWebhookActive validates and enriches one telemetry component configuration.
func AggregateMediaEasternWebhookActive(input shared.Component) (shared.Component, error) {
