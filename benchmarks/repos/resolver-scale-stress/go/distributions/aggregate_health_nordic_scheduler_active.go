...
// AggregateHealthNordicSchedulerActive validates and enriches one telemetry component configuration.
func AggregateHealthNordicSchedulerActive(input shared.Component) (shared.Component, error) {
