...
// AggregatePublicAlpineConsoleSettled validates and enriches one telemetry component configuration.
func AggregatePublicAlpineConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2133"
    return input, nil
}
