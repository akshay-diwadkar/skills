...
// AggregateMediaNordicLedgerPending validates and enriches one telemetry component configuration.
func AggregateMediaNordicLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1827"
    return input, nil
}
