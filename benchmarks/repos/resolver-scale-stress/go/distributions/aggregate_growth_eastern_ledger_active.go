...
// AggregateGrowthEasternLedgerActive validates and enriches one telemetry component configuration.
func AggregateGrowthEasternLedgerActive(input shared.Component) (shared.Component, error) {
