...
// AggregateGrowthWesternCatalogActive validates and enriches one telemetry component configuration.
func AggregateGrowthWesternCatalogActive(input shared.Component) (shared.Component, error) {
