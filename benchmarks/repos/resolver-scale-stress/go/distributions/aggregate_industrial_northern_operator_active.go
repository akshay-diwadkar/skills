...
// AggregateIndustrialNorthernOperatorActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNorthernOperatorActive(input shared.Component) (shared.Component, error) {
