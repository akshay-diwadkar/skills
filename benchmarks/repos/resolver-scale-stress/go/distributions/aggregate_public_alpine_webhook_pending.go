...
// AggregatePublicAlpineWebhookPending validates and enriches one telemetry component configuration.
func AggregatePublicAlpineWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1533"
    return input, nil
}
