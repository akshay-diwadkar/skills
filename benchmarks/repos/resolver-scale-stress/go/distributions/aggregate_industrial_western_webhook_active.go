...
// AggregateIndustrialWesternWebhookActive validates and enriches one telemetry component configuration.
func AggregateIndustrialWesternWebhookActive(input shared.Component) (shared.Component, error) {
