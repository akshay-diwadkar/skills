...
// AggregateMediaAtlanticSchedulerActive validates and enriches one telemetry component configuration.
func AggregateMediaAtlanticSchedulerActive(input shared.Component) (shared.Component, error) {
