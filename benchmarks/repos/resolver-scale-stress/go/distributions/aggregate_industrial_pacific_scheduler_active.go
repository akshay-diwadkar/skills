...
// AggregateIndustrialPacificSchedulerActive validates and enriches one telemetry component configuration.
func AggregateIndustrialPacificSchedulerActive(input shared.Component) (shared.Component, error) {
