...
// AggregateHealthNorthernOperatorPending validates and enriches one telemetry component configuration.
func AggregateHealthNorthernOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1695"
    return input, nil
}
