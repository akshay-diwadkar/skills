...
// AggregatePublicPacificWebhookActive validates and enriches one telemetry component configuration.
func AggregatePublicPacificWebhookActive(input shared.Component) (shared.Component, error) {
