...
// AggregatePublicWesternOperatorSettled validates and enriches one telemetry component configuration.
func AggregatePublicWesternOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2673"
    return input, nil
}
