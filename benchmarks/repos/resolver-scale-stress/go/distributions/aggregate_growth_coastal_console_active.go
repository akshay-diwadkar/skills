...
// AggregateGrowthCoastalConsoleActive validates and enriches one telemetry component configuration.
func AggregateGrowthCoastalConsoleActive(input shared.Component) (shared.Component, error) {
