...
// AggregateHealthAtlanticBatchActive validates and enriches one telemetry component configuration.
func AggregateHealthAtlanticBatchActive(input shared.Component) (shared.Component, error) {
