...
// AggregateMediaSouthernGatewayActive validates and enriches one telemetry component configuration.
func AggregateMediaSouthernGatewayActive(input shared.Component) (shared.Component, error) {
