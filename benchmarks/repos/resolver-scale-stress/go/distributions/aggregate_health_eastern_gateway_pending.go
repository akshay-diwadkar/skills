...
// AggregateHealthEasternGatewayPending validates and enriches one telemetry component configuration.
func AggregateHealthEasternGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1065"
    return input, nil
}
