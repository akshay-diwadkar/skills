...
// AggregatePublicSouthernConsoleActive validates and enriches one telemetry component configuration.
func AggregatePublicSouthernConsoleActive(input shared.Component) (shared.Component, error) {
