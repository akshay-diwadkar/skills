...
// AggregateIndustrialNorthernGatewayActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNorthernGatewayActive(input shared.Component) (shared.Component, error) {
