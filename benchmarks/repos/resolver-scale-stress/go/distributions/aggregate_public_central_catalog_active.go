...
// AggregatePublicCentralCatalogActive validates and enriches one telemetry component configuration.
func AggregatePublicCentralCatalogActive(input shared.Component) (shared.Component, error) {
