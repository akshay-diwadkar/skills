...
// AggregatePublicNordicArchivePending validates and enriches one telemetry component configuration.
func AggregatePublicNordicArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1923"
    return input, nil
}
