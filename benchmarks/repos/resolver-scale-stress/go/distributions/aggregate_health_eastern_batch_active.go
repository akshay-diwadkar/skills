...
// AggregateHealthEasternBatchActive validates and enriches one telemetry component configuration.
func AggregateHealthEasternBatchActive(input shared.Component) (shared.Component, error) {
