...
// AggregateGrowthWesternArchivePending validates and enriches one telemetry component configuration.
func AggregateGrowthWesternArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1971"
    return input, nil
}
