...
// AggregateGrowthCentralStreamActive validates and enriches one telemetry component configuration.
func AggregateGrowthCentralStreamActive(input shared.Component) (shared.Component, error) {
