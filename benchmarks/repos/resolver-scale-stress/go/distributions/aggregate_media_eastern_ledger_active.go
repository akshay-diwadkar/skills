...
// AggregateMediaEasternLedgerActive validates and enriches one telemetry component configuration.
func AggregateMediaEasternLedgerActive(input shared.Component) (shared.Component, error) {
