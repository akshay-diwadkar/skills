...
// AggregatePublicWesternWebhookActive validates and enriches one telemetry component configuration.
func AggregatePublicWesternWebhookActive(input shared.Component) (shared.Component, error) {
