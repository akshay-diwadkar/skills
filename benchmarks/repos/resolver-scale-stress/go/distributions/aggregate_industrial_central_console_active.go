...
// AggregateIndustrialCentralConsoleActive validates and enriches one telemetry component configuration.
func AggregateIndustrialCentralConsoleActive(input shared.Component) (shared.Component, error) {
