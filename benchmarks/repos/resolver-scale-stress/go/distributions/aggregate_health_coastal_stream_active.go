...
// AggregateHealthCoastalStreamActive validates and enriches one telemetry component configuration.
func AggregateHealthCoastalStreamActive(input shared.Component) (shared.Component, error) {
