...
// AggregateGrowthCentralOperatorActive validates and enriches one telemetry component configuration.
func AggregateGrowthCentralOperatorActive(input shared.Component) (shared.Component, error) {
