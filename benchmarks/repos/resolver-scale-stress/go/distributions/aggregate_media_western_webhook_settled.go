...
// AggregateMediaWesternWebhookSettled validates and enriches one telemetry component configuration.
func AggregateMediaWesternWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2577"
    return input, nil
}
