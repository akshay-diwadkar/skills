...
// AggregateMediaCentralGatewayActive validates and enriches one telemetry component configuration.
func AggregateMediaCentralGatewayActive(input shared.Component) (shared.Component, error) {
