...
// AggregateIndustrialNorthernArchiveActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNorthernArchiveActive(input shared.Component) (shared.Component, error) {
