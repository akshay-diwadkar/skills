...
// AggregateGrowthCentralArchiveActive validates and enriches one telemetry component configuration.
func AggregateGrowthCentralArchiveActive(input shared.Component) (shared.Component, error) {
