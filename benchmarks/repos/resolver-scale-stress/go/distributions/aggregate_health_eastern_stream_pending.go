...
// AggregateHealthEasternStreamPending validates and enriches one telemetry component configuration.
func AggregateHealthEasternStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1365"
    return input, nil
}
