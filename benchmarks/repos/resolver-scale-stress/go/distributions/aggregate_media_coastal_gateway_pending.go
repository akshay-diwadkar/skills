...
// AggregateMediaCoastalGatewayPending validates and enriches one telemetry component configuration.
func AggregateMediaCoastalGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1047"
    return input, nil
}
