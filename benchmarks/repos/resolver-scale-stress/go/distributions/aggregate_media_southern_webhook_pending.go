...
// AggregateMediaSouthernWebhookPending validates and enriches one telemetry component configuration.
func AggregateMediaSouthernWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1587"
    return input, nil
}
