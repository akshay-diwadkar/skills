...
// AggregatePublicEasternSchedulerPending validates and enriches one telemetry component configuration.
func AggregatePublicEasternSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1263"
    return input, nil
}
