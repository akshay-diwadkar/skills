...
// AggregateHealthAtlanticCatalogActive validates and enriches one telemetry component configuration.
func AggregateHealthAtlanticCatalogActive(input shared.Component) (shared.Component, error) {
