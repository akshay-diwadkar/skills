...
// AggregateGrowthEasternBatchPending validates and enriches one telemetry component configuration.
func AggregateGrowthEasternBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1461"
    return input, nil
}
