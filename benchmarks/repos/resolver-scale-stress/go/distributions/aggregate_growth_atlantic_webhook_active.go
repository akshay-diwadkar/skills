...
// AggregateGrowthAtlanticWebhookActive validates and enriches one telemetry component configuration.
func AggregateGrowthAtlanticWebhookActive(input shared.Component) (shared.Component, error) {
