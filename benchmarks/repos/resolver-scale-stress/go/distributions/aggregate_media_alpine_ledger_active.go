...
// AggregateMediaAlpineLedgerActive validates and enriches one telemetry component configuration.
func AggregateMediaAlpineLedgerActive(input shared.Component) (shared.Component, error) {
