...
// AggregateMediaNorthernGatewaySettled validates and enriches one telemetry component configuration.
func AggregateMediaNorthernGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2097"
    return input, nil
}
