...
// AggregateHealthCoastalGatewayActive validates and enriches one telemetry component configuration.
func AggregateHealthCoastalGatewayActive(input shared.Component) (shared.Component, error) {
