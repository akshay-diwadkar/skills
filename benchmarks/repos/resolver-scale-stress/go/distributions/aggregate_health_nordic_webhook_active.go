...
// AggregateHealthNordicWebhookActive validates and enriches one telemetry component configuration.
func AggregateHealthNordicWebhookActive(input shared.Component) (shared.Component, error) {
