...
// AggregateIndustrialNorthernStreamActive validates and enriches one telemetry component configuration.
func AggregateIndustrialNorthernStreamActive(input shared.Component) (shared.Component, error) {
