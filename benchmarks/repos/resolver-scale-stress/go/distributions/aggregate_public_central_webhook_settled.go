...
// AggregatePublicCentralWebhookSettled validates and enriches one telemetry component configuration.
func AggregatePublicCentralWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2553"
    return input, nil
}
