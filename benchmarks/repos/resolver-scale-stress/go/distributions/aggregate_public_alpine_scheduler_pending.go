...
// AggregatePublicAlpineSchedulerPending validates and enriches one telemetry component configuration.
func AggregatePublicAlpineSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1233"
    return input, nil
}
