...
// AggregateMediaPacificWebhookSettled validates and enriches one telemetry component configuration.
func AggregateMediaPacificWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2517"
    return input, nil
}
