...
// AggregateMediaAtlanticLedgerActive validates and enriches one telemetry component configuration.
func AggregateMediaAtlanticLedgerActive(input shared.Component) (shared.Component, error) {
