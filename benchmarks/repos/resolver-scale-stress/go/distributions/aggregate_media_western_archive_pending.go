...
// AggregateMediaWesternArchivePending validates and enriches one telemetry component configuration.
func AggregateMediaWesternArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1977"
    return input, nil
}
