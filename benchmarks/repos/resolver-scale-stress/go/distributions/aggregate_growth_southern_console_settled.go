...
// AggregateGrowthSouthernConsoleSettled validates and enriches one telemetry component configuration.
func AggregateGrowthSouthernConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2181"
    return input, nil
}
