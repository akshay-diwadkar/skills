...
// AggregateGrowthAtlanticBatchPending validates and enriches one telemetry component configuration.
func AggregateGrowthAtlanticBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1401"
    return input, nil
}
