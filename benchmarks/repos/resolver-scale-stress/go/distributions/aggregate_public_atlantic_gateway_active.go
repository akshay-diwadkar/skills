...
// AggregatePublicAtlanticGatewayActive validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticGatewayActive(input shared.Component) (shared.Component, error) {
