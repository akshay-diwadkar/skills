...
// AggregateIndustrialAtlanticStreamActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAtlanticStreamActive(input shared.Component) (shared.Component, error) {
