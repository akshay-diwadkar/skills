...
// AggregateMediaNordicStreamActive validates and enriches one telemetry component configuration.
func AggregateMediaNordicStreamActive(input shared.Component) (shared.Component, error) {
