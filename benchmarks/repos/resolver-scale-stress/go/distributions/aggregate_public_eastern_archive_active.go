...
// AggregatePublicEasternArchiveActive validates and enriches one telemetry component configuration.
func AggregatePublicEasternArchiveActive(input shared.Component) (shared.Component, error) {
