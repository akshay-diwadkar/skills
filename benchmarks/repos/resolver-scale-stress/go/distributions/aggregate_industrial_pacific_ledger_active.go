...
// AggregateIndustrialPacificLedgerActive validates and enriches one telemetry component configuration.
func AggregateIndustrialPacificLedgerActive(input shared.Component) (shared.Component, error) {
