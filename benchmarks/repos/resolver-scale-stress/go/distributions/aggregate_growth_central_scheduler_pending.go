...
// AggregateGrowthCentralSchedulerPending validates and enriches one telemetry component configuration.
func AggregateGrowthCentralSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1251"
    return input, nil
}
