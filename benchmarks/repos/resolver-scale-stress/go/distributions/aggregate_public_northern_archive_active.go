...
// AggregatePublicNorthernArchiveActive validates and enriches one telemetry component configuration.
func AggregatePublicNorthernArchiveActive(input shared.Component) (shared.Component, error) {
