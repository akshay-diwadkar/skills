...
// AggregateGrowthPacificConsoleActive validates and enriches one telemetry component configuration.
func AggregateGrowthPacificConsoleActive(input shared.Component) (shared.Component, error) {
