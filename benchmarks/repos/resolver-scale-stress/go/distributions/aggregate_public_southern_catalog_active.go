...
// AggregatePublicSouthernCatalogActive validates and enriches one telemetry component configuration.
func AggregatePublicSouthernCatalogActive(input shared.Component) (shared.Component, error) {
