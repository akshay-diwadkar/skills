...
// AggregatePublicNorthernCatalogSettled validates and enriches one telemetry component configuration.
func AggregatePublicNorthernCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2793"
    return input, nil
}
