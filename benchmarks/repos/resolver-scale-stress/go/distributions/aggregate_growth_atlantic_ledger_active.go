...
// AggregateGrowthAtlanticLedgerActive validates and enriches one telemetry component configuration.
func AggregateGrowthAtlanticLedgerActive(input shared.Component) (shared.Component, error) {
