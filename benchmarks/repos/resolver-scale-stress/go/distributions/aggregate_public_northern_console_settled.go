...
// AggregatePublicNorthernConsoleSettled validates and enriches one telemetry component configuration.
func AggregatePublicNorthernConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2193"
    return input, nil
}
