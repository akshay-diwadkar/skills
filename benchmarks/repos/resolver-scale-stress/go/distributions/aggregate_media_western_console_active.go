...
// AggregateMediaWesternConsoleActive validates and enriches one telemetry component configuration.
func AggregateMediaWesternConsoleActive(input shared.Component) (shared.Component, error) {
