...
// AggregateIndustrialSouthernBatchActive validates and enriches one telemetry component configuration.
func AggregateIndustrialSouthernBatchActive(input shared.Component) (shared.Component, error) {
