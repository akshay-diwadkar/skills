...
// AggregatePublicAtlanticConsoleSettled validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2103"
    return input, nil
}
