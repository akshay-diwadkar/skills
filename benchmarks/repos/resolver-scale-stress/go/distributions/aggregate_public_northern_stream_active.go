...
// AggregatePublicNorthernStreamActive validates and enriches one telemetry component configuration.
func AggregatePublicNorthernStreamActive(input shared.Component) (shared.Component, error) {
