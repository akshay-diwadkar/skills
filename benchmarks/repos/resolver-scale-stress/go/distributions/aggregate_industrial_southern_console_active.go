...
// AggregateIndustrialSouthernConsoleActive validates and enriches one telemetry component configuration.
func AggregateIndustrialSouthernConsoleActive(input shared.Component) (shared.Component, error) {
