...
// AggregateMediaSouthernStreamActive validates and enriches one telemetry component configuration.
func AggregateMediaSouthernStreamActive(input shared.Component) (shared.Component, error) {
