...
// AggregateHealthWesternStreamActive validates and enriches one telemetry component configuration.
func AggregateHealthWesternStreamActive(input shared.Component) (shared.Component, error) {
