...
// AggregateIndustrialAtlanticConsoleSettled validates and enriches one telemetry component configuration.
func AggregateIndustrialAtlanticConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2109"
    return input, nil
}
