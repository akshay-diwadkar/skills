...
// AggregatePublicWesternStreamSettled validates and enriches one telemetry component configuration.
func AggregatePublicWesternStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2373"
    return input, nil
}
