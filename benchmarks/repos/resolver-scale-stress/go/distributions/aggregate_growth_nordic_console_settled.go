...
// AggregateGrowthNordicConsoleSettled validates and enriches one telemetry component configuration.
func AggregateGrowthNordicConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2121"
    return input, nil
}
