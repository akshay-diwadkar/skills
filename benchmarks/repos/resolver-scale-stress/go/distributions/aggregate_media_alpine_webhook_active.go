...
// AggregateMediaAlpineWebhookActive validates and enriches one telemetry component configuration.
func AggregateMediaAlpineWebhookActive(input shared.Component) (shared.Component, error) {
