...
// AggregatePublicPacificSchedulerActive validates and enriches one telemetry component configuration.
func AggregatePublicPacificSchedulerActive(input shared.Component) (shared.Component, error) {
