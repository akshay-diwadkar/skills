...
// AggregateMediaWesternGatewayPending validates and enriches one telemetry component configuration.
func AggregateMediaWesternGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1077"
    return input, nil
}
