...
// AggregateGrowthAtlanticConsolePending validates and enriches one telemetry component configuration.
func AggregateGrowthAtlanticConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1101"
    return input, nil
}
