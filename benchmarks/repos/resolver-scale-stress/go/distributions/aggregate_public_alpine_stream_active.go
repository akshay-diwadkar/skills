...
// AggregatePublicAlpineStreamActive validates and enriches one telemetry component configuration.
func AggregatePublicAlpineStreamActive(input shared.Component) (shared.Component, error) {
