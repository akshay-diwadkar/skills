...
// AggregatePublicCentralConsoleActive validates and enriches one telemetry component configuration.
func AggregatePublicCentralConsoleActive(input shared.Component) (shared.Component, error) {
