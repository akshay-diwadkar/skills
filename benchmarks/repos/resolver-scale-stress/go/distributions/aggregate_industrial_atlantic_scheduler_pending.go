...
// AggregateIndustrialAtlanticSchedulerPending validates and enriches one telemetry component configuration.
func AggregateIndustrialAtlanticSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1209"
    return input, nil
}
