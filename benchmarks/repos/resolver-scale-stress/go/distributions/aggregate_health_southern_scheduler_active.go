...
// AggregateHealthSouthernSchedulerActive validates and enriches one telemetry component configuration.
func AggregateHealthSouthernSchedulerActive(input shared.Component) (shared.Component, error) {
