...
// AggregateGrowthWesternConsoleActive validates and enriches one telemetry component configuration.
func AggregateGrowthWesternConsoleActive(input shared.Component) (shared.Component, error) {
