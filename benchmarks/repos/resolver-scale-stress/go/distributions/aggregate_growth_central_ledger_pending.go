...
// AggregateGrowthCentralLedgerPending validates and enriches one telemetry component configuration.
func AggregateGrowthCentralLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1851"
    return input, nil
}
