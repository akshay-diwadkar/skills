...
// AggregatePublicAtlanticCatalogSettled validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2703"
    return input, nil
}
