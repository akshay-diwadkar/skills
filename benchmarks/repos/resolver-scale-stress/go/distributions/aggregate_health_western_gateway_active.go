...
// AggregateHealthWesternGatewayActive validates and enriches one telemetry component configuration.
func AggregateHealthWesternGatewayActive(input shared.Component) (shared.Component, error) {
