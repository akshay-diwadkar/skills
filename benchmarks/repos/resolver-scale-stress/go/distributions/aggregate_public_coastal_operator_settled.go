...
// AggregatePublicCoastalOperatorSettled validates and enriches one telemetry component configuration.
func AggregatePublicCoastalOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2643"
    return input, nil
}
