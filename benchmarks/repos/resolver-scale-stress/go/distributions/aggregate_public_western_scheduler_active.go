...
// AggregatePublicWesternSchedulerActive validates and enriches one telemetry component configuration.
func AggregatePublicWesternSchedulerActive(input shared.Component) (shared.Component, error) {
