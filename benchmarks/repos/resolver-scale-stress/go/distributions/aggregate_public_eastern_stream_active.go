...
// AggregatePublicEasternStreamActive validates and enriches one telemetry component configuration.
func AggregatePublicEasternStreamActive(input shared.Component) (shared.Component, error) {
