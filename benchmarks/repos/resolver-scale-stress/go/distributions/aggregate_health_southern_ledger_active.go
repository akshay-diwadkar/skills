...
// AggregateHealthSouthernLedgerActive validates and enriches one telemetry component configuration.
func AggregateHealthSouthernLedgerActive(input shared.Component) (shared.Component, error) {
