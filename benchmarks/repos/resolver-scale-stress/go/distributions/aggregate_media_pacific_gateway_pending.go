...
// AggregateMediaPacificGatewayPending validates and enriches one telemetry component configuration.
func AggregateMediaPacificGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1017"
    return input, nil
}
