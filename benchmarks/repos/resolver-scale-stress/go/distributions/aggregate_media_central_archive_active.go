...
// AggregateMediaCentralArchiveActive validates and enriches one telemetry component configuration.
func AggregateMediaCentralArchiveActive(input shared.Component) (shared.Component, error) {
