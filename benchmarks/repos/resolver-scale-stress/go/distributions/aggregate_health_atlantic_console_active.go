...
// AggregateHealthAtlanticConsoleActive validates and enriches one telemetry component configuration.
func AggregateHealthAtlanticConsoleActive(input shared.Component) (shared.Component, error) {
