...
// AggregatePublicSouthernGatewayPending validates and enriches one telemetry component configuration.
func AggregatePublicSouthernGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1083"
    return input, nil
}
