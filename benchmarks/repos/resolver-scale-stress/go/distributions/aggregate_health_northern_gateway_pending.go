...
// AggregateHealthNorthernGatewayPending validates and enriches one telemetry component configuration.
func AggregateHealthNorthernGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1095"
    return input, nil
}
