...
// AggregateGrowthSouthernGatewayActive validates and enriches one telemetry component configuration.
func AggregateGrowthSouthernGatewayActive(input shared.Component) (shared.Component, error) {
