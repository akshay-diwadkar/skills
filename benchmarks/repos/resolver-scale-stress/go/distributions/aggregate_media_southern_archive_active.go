...
// AggregateMediaSouthernArchiveActive validates and enriches one telemetry component configuration.
func AggregateMediaSouthernArchiveActive(input shared.Component) (shared.Component, error) {
