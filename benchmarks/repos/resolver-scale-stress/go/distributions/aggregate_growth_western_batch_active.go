...
// AggregateGrowthWesternBatchActive validates and enriches one telemetry component configuration.
func AggregateGrowthWesternBatchActive(input shared.Component) (shared.Component, error) {
