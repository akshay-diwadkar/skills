...
// AggregateMediaCentralConsoleSettled validates and enriches one telemetry component configuration.
func AggregateMediaCentralConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2157"
    return input, nil
}
