...
// AggregateIndustrialPacificConsolePending validates and enriches one telemetry component configuration.
func AggregateIndustrialPacificConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1119"
    return input, nil
}
