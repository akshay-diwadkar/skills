...
// AggregateMediaNordicArchiveActive validates and enriches one telemetry component configuration.
func AggregateMediaNordicArchiveActive(input shared.Component) (shared.Component, error) {
