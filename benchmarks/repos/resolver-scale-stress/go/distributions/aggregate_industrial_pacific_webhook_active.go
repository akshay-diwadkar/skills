...
// AggregateIndustrialPacificWebhookActive validates and enriches one telemetry component configuration.
func AggregateIndustrialPacificWebhookActive(input shared.Component) (shared.Component, error) {
