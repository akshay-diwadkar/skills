...
// AggregateGrowthAlpineWebhookActive validates and enriches one telemetry component configuration.
func AggregateGrowthAlpineWebhookActive(input shared.Component) (shared.Component, error) {
