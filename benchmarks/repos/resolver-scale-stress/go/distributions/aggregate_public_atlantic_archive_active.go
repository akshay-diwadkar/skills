...
// AggregatePublicAtlanticArchiveActive validates and enriches one telemetry component configuration.
func AggregatePublicAtlanticArchiveActive(input shared.Component) (shared.Component, error) {
