...
// AggregateMediaWesternOperatorPending validates and enriches one telemetry component configuration.
func AggregateMediaWesternOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1677"
    return input, nil
}
