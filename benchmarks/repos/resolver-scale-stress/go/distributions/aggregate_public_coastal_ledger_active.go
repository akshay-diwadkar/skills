...
// AggregatePublicCoastalLedgerActive validates and enriches one telemetry component configuration.
func AggregatePublicCoastalLedgerActive(input shared.Component) (shared.Component, error) {
