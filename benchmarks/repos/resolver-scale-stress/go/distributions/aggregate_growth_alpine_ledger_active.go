...
// AggregateGrowthAlpineLedgerActive validates and enriches one telemetry component configuration.
func AggregateGrowthAlpineLedgerActive(input shared.Component) (shared.Component, error) {
