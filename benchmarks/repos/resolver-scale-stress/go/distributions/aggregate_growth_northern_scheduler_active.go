...
// AggregateGrowthNorthernSchedulerActive validates and enriches one telemetry component configuration.
func AggregateGrowthNorthernSchedulerActive(input shared.Component) (shared.Component, error) {
