...
// AggregateHealthCentralLedgerActive validates and enriches one telemetry component configuration.
func AggregateHealthCentralLedgerActive(input shared.Component) (shared.Component, error) {
