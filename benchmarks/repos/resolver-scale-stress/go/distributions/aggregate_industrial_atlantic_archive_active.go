...
// AggregateIndustrialAtlanticArchiveActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAtlanticArchiveActive(input shared.Component) (shared.Component, error) {
