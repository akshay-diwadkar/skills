...
// AggregateMediaSouthernLedgerPending validates and enriches one telemetry component configuration.
func AggregateMediaSouthernLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1887"
    return input, nil
}
