...
// AggregateHealthNorthernConsoleActive validates and enriches one telemetry component configuration.
func AggregateHealthNorthernConsoleActive(input shared.Component) (shared.Component, error) {
