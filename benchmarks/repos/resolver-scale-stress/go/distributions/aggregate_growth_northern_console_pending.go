...
// AggregateGrowthNorthernConsolePending validates and enriches one telemetry component configuration.
func AggregateGrowthNorthernConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1191"
    return input, nil
}
