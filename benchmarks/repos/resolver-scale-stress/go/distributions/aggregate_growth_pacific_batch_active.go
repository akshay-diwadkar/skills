...
// AggregateGrowthPacificBatchActive validates and enriches one telemetry component configuration.
func AggregateGrowthPacificBatchActive(input shared.Component) (shared.Component, error) {
