...
// AggregateGrowthNordicOperatorActive validates and enriches one telemetry component configuration.
func AggregateGrowthNordicOperatorActive(input shared.Component) (shared.Component, error) {
