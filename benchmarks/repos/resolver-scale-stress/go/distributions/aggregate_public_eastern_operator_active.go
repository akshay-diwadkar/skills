...
// AggregatePublicEasternOperatorActive validates and enriches one telemetry component configuration.
func AggregatePublicEasternOperatorActive(input shared.Component) (shared.Component, error) {
