...
// AggregateHealthSouthernConsolePending validates and enriches one telemetry component configuration.
func AggregateHealthSouthernConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1185"
    return input, nil
}
