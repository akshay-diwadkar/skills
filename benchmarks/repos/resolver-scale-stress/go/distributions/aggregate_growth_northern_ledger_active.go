...
// AggregateGrowthNorthernLedgerActive validates and enriches one telemetry component configuration.
func AggregateGrowthNorthernLedgerActive(input shared.Component) (shared.Component, error) {
