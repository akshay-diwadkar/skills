...
// AggregateHealthWesternArchiveActive validates and enriches one telemetry component configuration.
func AggregateHealthWesternArchiveActive(input shared.Component) (shared.Component, error) {
