...
// AggregateHealthNorthernCatalogActive validates and enriches one telemetry component configuration.
func AggregateHealthNorthernCatalogActive(input shared.Component) (shared.Component, error) {
