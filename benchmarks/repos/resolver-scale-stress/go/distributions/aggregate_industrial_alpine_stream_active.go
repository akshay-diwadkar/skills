...
// AggregateIndustrialAlpineStreamActive validates and enriches one telemetry component configuration.
func AggregateIndustrialAlpineStreamActive(input shared.Component) (shared.Component, error) {
