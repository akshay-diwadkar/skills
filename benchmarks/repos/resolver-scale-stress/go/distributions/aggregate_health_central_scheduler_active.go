...
// AggregateHealthCentralSchedulerActive validates and enriches one telemetry component configuration.
func AggregateHealthCentralSchedulerActive(input shared.Component) (shared.Component, error) {
