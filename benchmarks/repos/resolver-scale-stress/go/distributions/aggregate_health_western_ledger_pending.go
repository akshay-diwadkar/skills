...
// AggregateHealthWesternLedgerPending validates and enriches one telemetry component configuration.
func AggregateHealthWesternLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1875"
    return input, nil
}
