...
// AggregateMediaPacificBatchActive validates and enriches one telemetry component configuration.
func AggregateMediaPacificBatchActive(input shared.Component) (shared.Component, error) {
