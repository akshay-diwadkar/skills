...
// AggregatePublicCoastalSchedulerActive validates and enriches one telemetry component configuration.
func AggregatePublicCoastalSchedulerActive(input shared.Component) (shared.Component, error) {
