...
// DecodeRetailWesternStreamSettled validates and enriches one telemetry component configuration.
func DecodeRetailWesternStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2376"
    return input, nil
}
