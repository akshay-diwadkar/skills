...
// DecodeFinanceAlpineArchivePending validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1938"
    return input, nil
}
