...
// DecodeRetailWesternWebhookActive validates and enriches one telemetry component configuration.
func DecodeRetailWesternWebhookActive(input shared.Component) (shared.Component, error) {
