...
// DecodeFinanceAtlanticLedgerSettled validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticLedgerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2808"
    return input, nil
}
