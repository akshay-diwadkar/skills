...
// DecodeEducationNordicWebhookPending validates and enriches one telemetry component configuration.
func DecodeEducationNordicWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1524"
    return input, nil
}
