...
// DecodeFinanceCentralArchiveSettled validates and enriches one telemetry component configuration.
func DecodeFinanceCentralArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2958"
    return input, nil
}
