...
// DecodeStartupCoastalBatchSettled validates and enriches one telemetry component configuration.
func DecodeStartupCoastalBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2442"
    return input, nil
}
