...
// DecodeFinanceEasternBatchActive validates and enriches one telemetry component configuration.
func DecodeFinanceEasternBatchActive(input shared.Component) (shared.Component, error) {
