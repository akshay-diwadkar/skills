...
// DecodeRetailPacificWebhookActive validates and enriches one telemetry component configuration.
func DecodeRetailPacificWebhookActive(input shared.Component) (shared.Component, error) {
