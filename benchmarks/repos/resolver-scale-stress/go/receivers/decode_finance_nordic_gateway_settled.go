...
// DecodeFinanceNordicGatewaySettled validates and enriches one telemetry component configuration.
func DecodeFinanceNordicGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2028"
    return input, nil
}
