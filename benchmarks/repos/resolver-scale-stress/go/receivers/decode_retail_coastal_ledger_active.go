...
// DecodeRetailCoastalLedgerActive validates and enriches one telemetry component configuration.
func DecodeRetailCoastalLedgerActive(input shared.Component) (shared.Component, error) {
