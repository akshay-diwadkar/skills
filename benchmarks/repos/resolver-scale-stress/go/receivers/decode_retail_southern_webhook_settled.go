...
// DecodeRetailSouthernWebhookSettled validates and enriches one telemetry component configuration.
func DecodeRetailSouthernWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2586"
    return input, nil
}
