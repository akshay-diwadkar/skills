...
// DecodeStartupNordicConsolePending validates and enriches one telemetry component configuration.
func DecodeStartupNordicConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1122"
    return input, nil
}
