...
// DecodeFinanceWesternLedgerPending validates and enriches one telemetry component configuration.
func DecodeFinanceWesternLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1878"
    return input, nil
}
