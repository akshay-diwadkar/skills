...
// DecodeStartupNordicArchiveSettled validates and enriches one telemetry component configuration.
func DecodeStartupNordicArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2922"
    return input, nil
}
