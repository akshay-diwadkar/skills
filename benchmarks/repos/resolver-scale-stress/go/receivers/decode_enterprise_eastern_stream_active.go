...
// DecodeEnterpriseEasternStreamActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseEasternStreamActive(input shared.Component) (shared.Component, error) {
