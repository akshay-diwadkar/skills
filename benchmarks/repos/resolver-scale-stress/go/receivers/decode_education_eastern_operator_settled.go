...
// DecodeEducationEasternOperatorSettled validates and enriches one telemetry component configuration.
func DecodeEducationEasternOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2664"
    return input, nil
}
