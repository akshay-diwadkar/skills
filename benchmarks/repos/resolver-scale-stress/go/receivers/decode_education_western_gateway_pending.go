...
// DecodeEducationWesternGatewayPending validates and enriches one telemetry component configuration.
func DecodeEducationWesternGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1074"
    return input, nil
}
