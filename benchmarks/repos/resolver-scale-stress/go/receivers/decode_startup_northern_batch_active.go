...
// DecodeStartupNorthernBatchActive validates and enriches one telemetry component configuration.
func DecodeStartupNorthernBatchActive(input shared.Component) (shared.Component, error) {
