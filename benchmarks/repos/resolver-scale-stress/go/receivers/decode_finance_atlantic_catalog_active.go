...
// DecodeFinanceAtlanticCatalogActive validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticCatalogActive(input shared.Component) (shared.Component, error) {
