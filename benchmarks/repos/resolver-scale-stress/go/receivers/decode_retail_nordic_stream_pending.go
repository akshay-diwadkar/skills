...
// DecodeRetailNordicStreamPending validates and enriches one telemetry component configuration.
func DecodeRetailNordicStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1326"
    return input, nil
}
