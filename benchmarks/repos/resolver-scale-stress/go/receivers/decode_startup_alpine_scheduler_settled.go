...
// DecodeStartupAlpineSchedulerSettled validates and enriches one telemetry component configuration.
func DecodeStartupAlpineSchedulerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2232"
    return input, nil
}
