...
// DecodeFinanceNordicStreamSettled validates and enriches one telemetry component configuration.
func DecodeFinanceNordicStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2328"
    return input, nil
}
