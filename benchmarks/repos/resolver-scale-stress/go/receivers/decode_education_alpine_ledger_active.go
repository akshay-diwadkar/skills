...
// DecodeEducationAlpineLedgerActive validates and enriches one telemetry component configuration.
func DecodeEducationAlpineLedgerActive(input shared.Component) (shared.Component, error) {
