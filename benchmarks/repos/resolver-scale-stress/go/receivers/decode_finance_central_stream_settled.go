...
// DecodeFinanceCentralStreamSettled validates and enriches one telemetry component configuration.
func DecodeFinanceCentralStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2358"
    return input, nil
}
