...
// DecodeFinanceSouthernOperatorSettled validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2688"
    return input, nil
}
