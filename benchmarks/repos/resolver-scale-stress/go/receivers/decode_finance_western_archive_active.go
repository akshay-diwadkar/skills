...
// DecodeFinanceWesternArchiveActive validates and enriches one telemetry component configuration.
func DecodeFinanceWesternArchiveActive(input shared.Component) (shared.Component, error) {
