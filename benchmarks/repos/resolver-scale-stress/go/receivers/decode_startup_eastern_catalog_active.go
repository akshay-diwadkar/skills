...
// DecodeStartupEasternCatalogActive validates and enriches one telemetry component configuration.
func DecodeStartupEasternCatalogActive(input shared.Component) (shared.Component, error) {
