...
// DecodeRetailNordicBatchActive validates and enriches one telemetry component configuration.
func DecodeRetailNordicBatchActive(input shared.Component) (shared.Component, error) {
