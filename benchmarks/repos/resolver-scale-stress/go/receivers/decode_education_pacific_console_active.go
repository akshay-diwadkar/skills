...
// DecodeEducationPacificConsoleActive validates and enriches one telemetry component configuration.
func DecodeEducationPacificConsoleActive(input shared.Component) (shared.Component, error) {
