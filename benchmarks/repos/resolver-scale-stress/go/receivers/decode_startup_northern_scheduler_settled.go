...
// DecodeStartupNorthernSchedulerSettled validates and enriches one telemetry component configuration.
func DecodeStartupNorthernSchedulerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2292"
    return input, nil
}
