...
// DecodeEnterpriseNorthernWebhookPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseNorthernWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1590"
    return input, nil
}
