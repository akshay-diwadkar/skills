...
// DecodeRetailWesternBatchPending validates and enriches one telemetry component configuration.
func DecodeRetailWesternBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1476"
    return input, nil
}
