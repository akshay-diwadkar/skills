...
// DecodeStartupAlpineWebhookSettled validates and enriches one telemetry component configuration.
func DecodeStartupAlpineWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2532"
    return input, nil
}
