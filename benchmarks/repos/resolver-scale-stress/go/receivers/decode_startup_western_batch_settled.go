...
// DecodeStartupWesternBatchSettled validates and enriches one telemetry component configuration.
func DecodeStartupWesternBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2472"
    return input, nil
}
