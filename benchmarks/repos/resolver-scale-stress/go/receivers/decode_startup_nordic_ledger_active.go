...
// DecodeStartupNordicLedgerActive validates and enriches one telemetry component configuration.
func DecodeStartupNordicLedgerActive(input shared.Component) (shared.Component, error) {
