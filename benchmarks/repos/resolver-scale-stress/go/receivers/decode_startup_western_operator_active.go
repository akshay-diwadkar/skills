...
// DecodeStartupWesternOperatorActive validates and enriches one telemetry component configuration.
func DecodeStartupWesternOperatorActive(input shared.Component) (shared.Component, error) {
