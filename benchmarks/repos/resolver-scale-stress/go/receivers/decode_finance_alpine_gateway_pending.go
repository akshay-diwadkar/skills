...
// DecodeFinanceAlpineGatewayPending validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1038"
    return input, nil
}
