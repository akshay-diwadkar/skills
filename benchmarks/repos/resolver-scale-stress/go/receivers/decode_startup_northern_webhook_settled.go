...
// DecodeStartupNorthernWebhookSettled validates and enriches one telemetry component configuration.
func DecodeStartupNorthernWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2592"
    return input, nil
}
