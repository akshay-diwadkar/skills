...
// DecodeRetailWesternLedgerActive validates and enriches one telemetry component configuration.
func DecodeRetailWesternLedgerActive(input shared.Component) (shared.Component, error) {
