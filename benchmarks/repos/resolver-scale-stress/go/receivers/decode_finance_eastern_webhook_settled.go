...
// DecodeFinanceEasternWebhookSettled validates and enriches one telemetry component configuration.
func DecodeFinanceEasternWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2568"
    return input, nil
}
