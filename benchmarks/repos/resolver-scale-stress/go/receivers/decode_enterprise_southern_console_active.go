...
// DecodeEnterpriseSouthernConsoleActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseSouthernConsoleActive(input shared.Component) (shared.Component, error) {
