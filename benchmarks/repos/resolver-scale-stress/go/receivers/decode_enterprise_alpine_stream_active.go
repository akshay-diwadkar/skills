...
// DecodeEnterpriseAlpineStreamActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAlpineStreamActive(input shared.Component) (shared.Component, error) {
