...
// DecodeEnterpriseNordicCatalogActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseNordicCatalogActive(input shared.Component) (shared.Component, error) {
