...
// DecodeStartupAtlanticGatewayPending validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1002"
    return input, nil
}
