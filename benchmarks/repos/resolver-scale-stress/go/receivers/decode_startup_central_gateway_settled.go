...
// DecodeStartupCentralGatewaySettled validates and enriches one telemetry component configuration.
func DecodeStartupCentralGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2052"
    return input, nil
}
