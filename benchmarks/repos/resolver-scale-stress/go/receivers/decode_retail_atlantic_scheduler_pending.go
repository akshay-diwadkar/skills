...
// DecodeRetailAtlanticSchedulerPending validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1206"
    return input, nil
}
