...
// DecodeEducationEasternWebhookActive validates and enriches one telemetry component configuration.
func DecodeEducationEasternWebhookActive(input shared.Component) (shared.Component, error) {
