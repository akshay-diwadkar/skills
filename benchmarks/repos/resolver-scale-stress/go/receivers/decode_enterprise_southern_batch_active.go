...
// DecodeEnterpriseSouthernBatchActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseSouthernBatchActive(input shared.Component) (shared.Component, error) {
