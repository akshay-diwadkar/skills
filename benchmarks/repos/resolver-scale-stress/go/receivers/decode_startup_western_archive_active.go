...
// DecodeStartupWesternArchiveActive validates and enriches one telemetry component configuration.
func DecodeStartupWesternArchiveActive(input shared.Component) (shared.Component, error) {
