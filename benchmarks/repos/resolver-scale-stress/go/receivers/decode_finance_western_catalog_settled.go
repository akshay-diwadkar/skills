...
// DecodeFinanceWesternCatalogSettled validates and enriches one telemetry component configuration.
func DecodeFinanceWesternCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2778"
    return input, nil
}
