...
// DecodeEnterpriseWesternStreamSettled validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2370"
    return input, nil
}
