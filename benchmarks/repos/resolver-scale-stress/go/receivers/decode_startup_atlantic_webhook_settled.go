...
// DecodeStartupAtlanticWebhookSettled validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2502"
    return input, nil
}
