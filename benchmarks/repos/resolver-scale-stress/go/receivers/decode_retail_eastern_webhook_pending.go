...
// DecodeRetailEasternWebhookPending validates and enriches one telemetry component configuration.
func DecodeRetailEasternWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1566"
    return input, nil
}
