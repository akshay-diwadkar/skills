...
// DecodeFinanceCoastalStreamActive validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalStreamActive(input shared.Component) (shared.Component, error) {
