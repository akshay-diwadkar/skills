...
// DecodeRetailCentralCatalogActive validates and enriches one telemetry component configuration.
func DecodeRetailCentralCatalogActive(input shared.Component) (shared.Component, error) {
