...
// DecodeEnterpriseCentralOperatorPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseCentralOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1650"
    return input, nil
}
