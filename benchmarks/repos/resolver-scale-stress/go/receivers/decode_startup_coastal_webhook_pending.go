...
// DecodeStartupCoastalWebhookPending validates and enriches one telemetry component configuration.
func DecodeStartupCoastalWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1542"
    return input, nil
}
