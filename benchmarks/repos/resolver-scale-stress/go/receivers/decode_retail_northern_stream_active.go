...
// DecodeRetailNorthernStreamActive validates and enriches one telemetry component configuration.
func DecodeRetailNorthernStreamActive(input shared.Component) (shared.Component, error) {
