...
// DecodeStartupCentralLedgerActive validates and enriches one telemetry component configuration.
func DecodeStartupCentralLedgerActive(input shared.Component) (shared.Component, error) {
