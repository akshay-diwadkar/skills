...
// DecodeEnterpriseWesternSchedulerActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternSchedulerActive(input shared.Component) (shared.Component, error) {
