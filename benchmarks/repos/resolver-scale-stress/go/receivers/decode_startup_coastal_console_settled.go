...
// DecodeStartupCoastalConsoleSettled validates and enriches one telemetry component configuration.
func DecodeStartupCoastalConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2142"
    return input, nil
}
