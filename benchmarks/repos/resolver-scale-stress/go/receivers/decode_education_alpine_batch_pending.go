...
// DecodeEducationAlpineBatchPending validates and enriches one telemetry component configuration.
func DecodeEducationAlpineBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1434"
    return input, nil
}
