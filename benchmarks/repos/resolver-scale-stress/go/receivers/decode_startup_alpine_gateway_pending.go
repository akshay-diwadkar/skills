...
// DecodeStartupAlpineGatewayPending validates and enriches one telemetry component configuration.
func DecodeStartupAlpineGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1032"
    return input, nil
}
