...
// DecodeStartupNordicStreamSettled validates and enriches one telemetry component configuration.
func DecodeStartupNordicStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2322"
    return input, nil
}
