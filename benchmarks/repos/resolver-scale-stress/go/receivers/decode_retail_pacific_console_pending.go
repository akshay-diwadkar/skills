...
// DecodeRetailPacificConsolePending validates and enriches one telemetry component configuration.
func DecodeRetailPacificConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1116"
    return input, nil
}
