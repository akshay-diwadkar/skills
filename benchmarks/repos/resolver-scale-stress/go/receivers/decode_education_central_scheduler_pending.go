...
// DecodeEducationCentralSchedulerPending validates and enriches one telemetry component configuration.
func DecodeEducationCentralSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1254"
    return input, nil
}
