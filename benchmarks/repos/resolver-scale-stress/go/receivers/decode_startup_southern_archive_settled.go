...
// DecodeStartupSouthernArchiveSettled validates and enriches one telemetry component configuration.
func DecodeStartupSouthernArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2982"
    return input, nil
}
