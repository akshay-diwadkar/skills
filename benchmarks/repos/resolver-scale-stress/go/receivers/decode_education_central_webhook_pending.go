...
// DecodeEducationCentralWebhookPending validates and enriches one telemetry component configuration.
func DecodeEducationCentralWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1554"
    return input, nil
}
