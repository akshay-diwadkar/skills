...
// DecodeFinanceCoastalConsoleSettled validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2148"
    return input, nil
}
