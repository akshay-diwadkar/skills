...
// DecodeRetailCoastalGatewaySettled validates and enriches one telemetry component configuration.
func DecodeRetailCoastalGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2046"
    return input, nil
}
