...
// DecodeEducationCentralStreamActive validates and enriches one telemetry component configuration.
func DecodeEducationCentralStreamActive(input shared.Component) (shared.Component, error) {
