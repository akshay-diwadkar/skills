...
// DecodeStartupAlpineConsoleActive validates and enriches one telemetry component configuration.
func DecodeStartupAlpineConsoleActive(input shared.Component) (shared.Component, error) {
