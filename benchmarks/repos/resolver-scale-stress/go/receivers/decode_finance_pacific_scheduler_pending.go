...
// DecodeFinancePacificSchedulerPending validates and enriches one telemetry component configuration.
func DecodeFinancePacificSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1218"
    return input, nil
}
