...
// DecodeRetailSouthernBatchActive validates and enriches one telemetry component configuration.
func DecodeRetailSouthernBatchActive(input shared.Component) (shared.Component, error) {
