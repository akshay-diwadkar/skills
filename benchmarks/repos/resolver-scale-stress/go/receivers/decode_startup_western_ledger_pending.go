...
// DecodeStartupWesternLedgerPending validates and enriches one telemetry component configuration.
func DecodeStartupWesternLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1872"
    return input, nil
}
