...
// DecodeRetailAlpineGatewayActive validates and enriches one telemetry component configuration.
func DecodeRetailAlpineGatewayActive(input shared.Component) (shared.Component, error) {
