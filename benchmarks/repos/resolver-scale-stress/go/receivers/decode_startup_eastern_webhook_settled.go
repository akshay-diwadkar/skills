...
// DecodeStartupEasternWebhookSettled validates and enriches one telemetry component configuration.
func DecodeStartupEasternWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2562"
    return input, nil
}
