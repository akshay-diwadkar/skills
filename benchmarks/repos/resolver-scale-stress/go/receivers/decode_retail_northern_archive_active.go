...
// DecodeRetailNorthernArchiveActive validates and enriches one telemetry component configuration.
func DecodeRetailNorthernArchiveActive(input shared.Component) (shared.Component, error) {
