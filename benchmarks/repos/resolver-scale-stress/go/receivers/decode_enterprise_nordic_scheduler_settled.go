...
// DecodeEnterpriseNordicSchedulerSettled validates and enriches one telemetry component configuration.
func DecodeEnterpriseNordicSchedulerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2220"
    return input, nil
}
