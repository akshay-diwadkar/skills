...
// DecodeEducationAlpineSchedulerActive validates and enriches one telemetry component configuration.
func DecodeEducationAlpineSchedulerActive(input shared.Component) (shared.Component, error) {
