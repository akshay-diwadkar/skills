...
// DecodeEnterpriseCentralGatewayPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseCentralGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1050"
    return input, nil
}
