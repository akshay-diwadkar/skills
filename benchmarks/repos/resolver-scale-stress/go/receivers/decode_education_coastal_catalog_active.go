...
// DecodeEducationCoastalCatalogActive validates and enriches one telemetry component configuration.
func DecodeEducationCoastalCatalogActive(input shared.Component) (shared.Component, error) {
