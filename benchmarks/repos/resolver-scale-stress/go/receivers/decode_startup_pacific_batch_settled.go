...
// DecodeStartupPacificBatchSettled validates and enriches one telemetry component configuration.
func DecodeStartupPacificBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2412"
    return input, nil
}
