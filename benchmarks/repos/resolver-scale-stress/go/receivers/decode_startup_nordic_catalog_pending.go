...
// DecodeStartupNordicCatalogPending validates and enriches one telemetry component configuration.
func DecodeStartupNordicCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1722"
    return input, nil
}
