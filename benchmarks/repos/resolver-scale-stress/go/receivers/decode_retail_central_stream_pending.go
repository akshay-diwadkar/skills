...
// DecodeRetailCentralStreamPending validates and enriches one telemetry component configuration.
func DecodeRetailCentralStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1356"
    return input, nil
}
