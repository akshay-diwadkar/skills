...
// DecodeStartupEasternBatchActive validates and enriches one telemetry component configuration.
func DecodeStartupEasternBatchActive(input shared.Component) (shared.Component, error) {
