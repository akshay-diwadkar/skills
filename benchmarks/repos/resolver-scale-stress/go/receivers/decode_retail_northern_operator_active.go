...
// DecodeRetailNorthernOperatorActive validates and enriches one telemetry component configuration.
func DecodeRetailNorthernOperatorActive(input shared.Component) (shared.Component, error) {
