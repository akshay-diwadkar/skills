...
// DecodeRetailNordicLedgerSettled validates and enriches one telemetry component configuration.
func DecodeRetailNordicLedgerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2826"
    return input, nil
}
