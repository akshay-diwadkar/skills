...
// DecodeFinanceSouthernSchedulerActive validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernSchedulerActive(input shared.Component) (shared.Component, error) {
