...
// DecodeFinanceAtlanticConsoleActive validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticConsoleActive(input shared.Component) (shared.Component, error) {
