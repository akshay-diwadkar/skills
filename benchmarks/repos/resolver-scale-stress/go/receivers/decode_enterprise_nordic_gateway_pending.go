...
// DecodeEnterpriseNordicGatewayPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseNordicGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1020"
    return input, nil
}
