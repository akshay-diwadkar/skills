...
// DecodeRetailAtlanticCatalogSettled validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2706"
    return input, nil
}
