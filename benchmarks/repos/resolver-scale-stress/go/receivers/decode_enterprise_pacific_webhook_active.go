...
// DecodeEnterprisePacificWebhookActive validates and enriches one telemetry component configuration.
func DecodeEnterprisePacificWebhookActive(input shared.Component) (shared.Component, error) {
