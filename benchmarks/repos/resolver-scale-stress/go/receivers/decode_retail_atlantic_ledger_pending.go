...
// DecodeRetailAtlanticLedgerPending validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1806"
    return input, nil
}
