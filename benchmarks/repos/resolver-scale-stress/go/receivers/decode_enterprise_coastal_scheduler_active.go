...
// DecodeEnterpriseCoastalSchedulerActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseCoastalSchedulerActive(input shared.Component) (shared.Component, error) {
