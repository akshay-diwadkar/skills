...
// DecodeStartupWesternSchedulerPending validates and enriches one telemetry component configuration.
func DecodeStartupWesternSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1272"
    return input, nil
}
