...
// DecodeFinanceNordicBatchPending validates and enriches one telemetry component configuration.
func DecodeFinanceNordicBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1428"
    return input, nil
}
