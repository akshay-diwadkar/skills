...
// DecodeRetailCentralSchedulerSettled validates and enriches one telemetry component configuration.
func DecodeRetailCentralSchedulerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2256"
    return input, nil
}
