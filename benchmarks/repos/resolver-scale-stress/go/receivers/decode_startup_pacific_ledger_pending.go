...
// DecodeStartupPacificLedgerPending validates and enriches one telemetry component configuration.
func DecodeStartupPacificLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1812"
    return input, nil
}
