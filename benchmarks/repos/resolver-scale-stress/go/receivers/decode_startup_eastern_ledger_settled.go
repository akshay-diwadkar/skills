...
// DecodeStartupEasternLedgerSettled validates and enriches one telemetry component configuration.
func DecodeStartupEasternLedgerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2862"
    return input, nil
}
