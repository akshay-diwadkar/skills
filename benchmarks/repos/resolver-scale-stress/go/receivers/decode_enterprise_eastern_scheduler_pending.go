...
// DecodeEnterpriseEasternSchedulerPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseEasternSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1260"
    return input, nil
}
