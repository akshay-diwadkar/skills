...
// DecodeFinancePacificOperatorActive validates and enriches one telemetry component configuration.
func DecodeFinancePacificOperatorActive(input shared.Component) (shared.Component, error) {
