...
// DecodeRetailSouthernArchivePending validates and enriches one telemetry component configuration.
func DecodeRetailSouthernArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1986"
    return input, nil
}
