...
// DecodeRetailCentralConsoleActive validates and enriches one telemetry component configuration.
func DecodeRetailCentralConsoleActive(input shared.Component) (shared.Component, error) {
