...
// DecodeFinancePacificBatchSettled validates and enriches one telemetry component configuration.
func DecodeFinancePacificBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2418"
    return input, nil
}
