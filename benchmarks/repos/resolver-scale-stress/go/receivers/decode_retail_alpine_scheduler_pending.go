...
// DecodeRetailAlpineSchedulerPending validates and enriches one telemetry component configuration.
func DecodeRetailAlpineSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1236"
    return input, nil
}
