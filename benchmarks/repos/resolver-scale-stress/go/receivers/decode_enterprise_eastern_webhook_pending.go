...
// DecodeEnterpriseEasternWebhookPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseEasternWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1560"
    return input, nil
}
