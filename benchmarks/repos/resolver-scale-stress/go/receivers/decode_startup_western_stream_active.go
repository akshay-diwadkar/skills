...
// DecodeStartupWesternStreamActive validates and enriches one telemetry component configuration.
func DecodeStartupWesternStreamActive(input shared.Component) (shared.Component, error) {
