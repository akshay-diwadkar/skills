...
// DecodeRetailAtlanticGatewayActive validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticGatewayActive(input shared.Component) (shared.Component, error) {
