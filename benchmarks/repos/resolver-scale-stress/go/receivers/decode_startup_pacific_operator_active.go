...
// DecodeStartupPacificOperatorActive validates and enriches one telemetry component configuration.
func DecodeStartupPacificOperatorActive(input shared.Component) (shared.Component, error) {
