...
// DecodeEducationPacificBatchActive validates and enriches one telemetry component configuration.
func DecodeEducationPacificBatchActive(input shared.Component) (shared.Component, error) {
