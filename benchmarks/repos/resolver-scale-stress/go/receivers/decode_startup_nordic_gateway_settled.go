...
// DecodeStartupNordicGatewaySettled validates and enriches one telemetry component configuration.
func DecodeStartupNordicGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2022"
    return input, nil
}
