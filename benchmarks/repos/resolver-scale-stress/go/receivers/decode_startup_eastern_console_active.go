...
// DecodeStartupEasternConsoleActive validates and enriches one telemetry component configuration.
func DecodeStartupEasternConsoleActive(input shared.Component) (shared.Component, error) {
