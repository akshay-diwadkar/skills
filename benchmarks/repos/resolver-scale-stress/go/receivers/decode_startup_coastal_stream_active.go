...
// DecodeStartupCoastalStreamActive validates and enriches one telemetry component configuration.
func DecodeStartupCoastalStreamActive(input shared.Component) (shared.Component, error) {
