...
// DecodeEnterpriseCoastalCatalogPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseCoastalCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1740"
    return input, nil
}
