...
// DecodeFinanceAlpineBatchActive validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineBatchActive(input shared.Component) (shared.Component, error) {
