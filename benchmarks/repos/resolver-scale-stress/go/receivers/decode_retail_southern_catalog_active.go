...
// DecodeRetailSouthernCatalogActive validates and enriches one telemetry component configuration.
func DecodeRetailSouthernCatalogActive(input shared.Component) (shared.Component, error) {
