...
// DecodeEducationNorthernBatchPending validates and enriches one telemetry component configuration.
func DecodeEducationNorthernBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1494"
    return input, nil
}
