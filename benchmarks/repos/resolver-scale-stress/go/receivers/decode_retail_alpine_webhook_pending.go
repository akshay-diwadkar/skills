...
// DecodeRetailAlpineWebhookPending validates and enriches one telemetry component configuration.
func DecodeRetailAlpineWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1536"
    return input, nil
}
