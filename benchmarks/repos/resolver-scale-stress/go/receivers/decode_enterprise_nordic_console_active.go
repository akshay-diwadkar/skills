...
// DecodeEnterpriseNordicConsoleActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseNordicConsoleActive(input shared.Component) (shared.Component, error) {
