...
// DecodeFinanceNorthernStreamPending validates and enriches one telemetry component configuration.
func DecodeFinanceNorthernStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1398"
    return input, nil
}
