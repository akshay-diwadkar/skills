...
// DecodeFinanceCoastalOperatorActive validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalOperatorActive(input shared.Component) (shared.Component, error) {
