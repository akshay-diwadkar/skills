...
// DecodeEducationPacificCatalogActive validates and enriches one telemetry component configuration.
func DecodeEducationPacificCatalogActive(input shared.Component) (shared.Component, error) {
