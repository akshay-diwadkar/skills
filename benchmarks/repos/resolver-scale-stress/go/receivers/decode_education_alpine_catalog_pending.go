...
// DecodeEducationAlpineCatalogPending validates and enriches one telemetry component configuration.
func DecodeEducationAlpineCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1734"
    return input, nil
}
