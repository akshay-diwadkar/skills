...
// DecodeRetailCoastalConsolePending validates and enriches one telemetry component configuration.
func DecodeRetailCoastalConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1146"
    return input, nil
}
