...
// DecodeRetailPacificSchedulerActive validates and enriches one telemetry component configuration.
func DecodeRetailPacificSchedulerActive(input shared.Component) (shared.Component, error) {
