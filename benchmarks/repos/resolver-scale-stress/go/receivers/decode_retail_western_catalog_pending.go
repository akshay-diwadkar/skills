...
// DecodeRetailWesternCatalogPending validates and enriches one telemetry component configuration.
func DecodeRetailWesternCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1776"
    return input, nil
}
