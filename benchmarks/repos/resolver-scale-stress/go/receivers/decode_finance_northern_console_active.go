...
// DecodeFinanceNorthernConsoleActive validates and enriches one telemetry component configuration.
func DecodeFinanceNorthernConsoleActive(input shared.Component) (shared.Component, error) {
