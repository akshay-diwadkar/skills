...
// DecodeEducationWesternCatalogActive validates and enriches one telemetry component configuration.
func DecodeEducationWesternCatalogActive(input shared.Component) (shared.Component, error) {
