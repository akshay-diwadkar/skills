...
// DecodeRetailCentralWebhookSettled validates and enriches one telemetry component configuration.
func DecodeRetailCentralWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2556"
    return input, nil
}
