...
// DecodeRetailCoastalCatalogPending validates and enriches one telemetry component configuration.
func DecodeRetailCoastalCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1746"
    return input, nil
}
