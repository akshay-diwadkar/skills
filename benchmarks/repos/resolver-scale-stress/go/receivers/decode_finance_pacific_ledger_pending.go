...
// DecodeFinancePacificLedgerPending validates and enriches one telemetry component configuration.
func DecodeFinancePacificLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1818"
    return input, nil
}
