...
// DecodeFinanceWesternOperatorActive validates and enriches one telemetry component configuration.
func DecodeFinanceWesternOperatorActive(input shared.Component) (shared.Component, error) {
