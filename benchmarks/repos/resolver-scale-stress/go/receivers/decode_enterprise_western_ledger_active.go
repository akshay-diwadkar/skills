...
// DecodeEnterpriseWesternLedgerActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternLedgerActive(input shared.Component) (shared.Component, error) {
