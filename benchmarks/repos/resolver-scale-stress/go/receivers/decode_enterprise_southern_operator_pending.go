...
// DecodeEnterpriseSouthernOperatorPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseSouthernOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1680"
    return input, nil
}
