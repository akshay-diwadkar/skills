...
// DecodeEnterpriseCoastalOperatorSettled validates and enriches one telemetry component configuration.
func DecodeEnterpriseCoastalOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2640"
    return input, nil
}
