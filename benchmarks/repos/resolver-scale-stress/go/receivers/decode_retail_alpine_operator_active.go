...
// DecodeRetailAlpineOperatorActive validates and enriches one telemetry component configuration.
func DecodeRetailAlpineOperatorActive(input shared.Component) (shared.Component, error) {
