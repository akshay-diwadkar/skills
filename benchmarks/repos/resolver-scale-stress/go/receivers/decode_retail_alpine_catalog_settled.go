...
// DecodeRetailAlpineCatalogSettled validates and enriches one telemetry component configuration.
func DecodeRetailAlpineCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2736"
    return input, nil
}
