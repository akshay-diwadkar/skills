...
// DecodeEnterpriseNorthernGatewayActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseNorthernGatewayActive(input shared.Component) (shared.Component, error) {
