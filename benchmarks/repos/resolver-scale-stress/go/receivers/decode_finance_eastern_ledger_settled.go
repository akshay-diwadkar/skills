...
// DecodeFinanceEasternLedgerSettled validates and enriches one telemetry component configuration.
func DecodeFinanceEasternLedgerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2868"
    return input, nil
}
