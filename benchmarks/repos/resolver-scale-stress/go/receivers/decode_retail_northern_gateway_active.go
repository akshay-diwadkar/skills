...
// DecodeRetailNorthernGatewayActive validates and enriches one telemetry component configuration.
func DecodeRetailNorthernGatewayActive(input shared.Component) (shared.Component, error) {
