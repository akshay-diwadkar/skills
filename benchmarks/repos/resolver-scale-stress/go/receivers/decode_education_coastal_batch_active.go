...
// DecodeEducationCoastalBatchActive validates and enriches one telemetry component configuration.
func DecodeEducationCoastalBatchActive(input shared.Component) (shared.Component, error) {
