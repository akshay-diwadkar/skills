...
// DecodeFinanceEasternGatewayPending validates and enriches one telemetry component configuration.
func DecodeFinanceEasternGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1068"
    return input, nil
}
