...
// DecodeFinanceWesternWebhookPending validates and enriches one telemetry component configuration.
func DecodeFinanceWesternWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1578"
    return input, nil
}
