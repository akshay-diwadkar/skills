...
// DecodeRetailCentralGatewayPending validates and enriches one telemetry component configuration.
func DecodeRetailCentralGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1056"
    return input, nil
}
