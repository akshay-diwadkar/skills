...
// DecodeStartupNordicWebhookActive validates and enriches one telemetry component configuration.
func DecodeStartupNordicWebhookActive(input shared.Component) (shared.Component, error) {
