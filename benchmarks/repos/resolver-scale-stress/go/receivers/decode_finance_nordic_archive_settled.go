...
// DecodeFinanceNordicArchiveSettled validates and enriches one telemetry component configuration.
func DecodeFinanceNordicArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2928"
    return input, nil
}
