...
// DecodeStartupPacificSchedulerPending validates and enriches one telemetry component configuration.
func DecodeStartupPacificSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1212"
    return input, nil
}
