...
// DecodeStartupAlpineOperatorPending validates and enriches one telemetry component configuration.
func DecodeStartupAlpineOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1632"
    return input, nil
}
