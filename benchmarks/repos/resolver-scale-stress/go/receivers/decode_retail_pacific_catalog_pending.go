...
// DecodeRetailPacificCatalogPending validates and enriches one telemetry component configuration.
func DecodeRetailPacificCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1716"
    return input, nil
}
