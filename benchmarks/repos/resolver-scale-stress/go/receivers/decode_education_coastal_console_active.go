...
// DecodeEducationCoastalConsoleActive validates and enriches one telemetry component configuration.
func DecodeEducationCoastalConsoleActive(input shared.Component) (shared.Component, error) {
