...
// DecodeEnterpriseAlpineOperatorActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAlpineOperatorActive(input shared.Component) (shared.Component, error) {
