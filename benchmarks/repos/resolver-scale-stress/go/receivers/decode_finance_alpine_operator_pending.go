...
// DecodeFinanceAlpineOperatorPending validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1638"
    return input, nil
}
