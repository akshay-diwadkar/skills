...
// DecodeEducationEasternSchedulerActive validates and enriches one telemetry component configuration.
func DecodeEducationEasternSchedulerActive(input shared.Component) (shared.Component, error) {
