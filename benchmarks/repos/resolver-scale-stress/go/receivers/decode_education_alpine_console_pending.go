...
// DecodeEducationAlpineConsolePending validates and enriches one telemetry component configuration.
func DecodeEducationAlpineConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1134"
    return input, nil
}
