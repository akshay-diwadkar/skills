...
// DecodeRetailNordicGatewayPending validates and enriches one telemetry component configuration.
func DecodeRetailNordicGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1026"
    return input, nil
}
