...
// DecodeRetailPacificArchiveSettled validates and enriches one telemetry component configuration.
func DecodeRetailPacificArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2916"
    return input, nil
}
