...
// DecodeEducationCoastalArchivePending validates and enriches one telemetry component configuration.
func DecodeEducationCoastalArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1944"
    return input, nil
}
