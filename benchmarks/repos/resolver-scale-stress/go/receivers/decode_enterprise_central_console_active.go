...
// DecodeEnterpriseCentralConsoleActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseCentralConsoleActive(input shared.Component) (shared.Component, error) {
