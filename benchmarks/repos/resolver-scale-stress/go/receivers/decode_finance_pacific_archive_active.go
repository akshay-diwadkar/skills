...
// DecodeFinancePacificArchiveActive validates and enriches one telemetry component configuration.
func DecodeFinancePacificArchiveActive(input shared.Component) (shared.Component, error) {
