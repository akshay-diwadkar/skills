...
// DecodeRetailEasternSchedulerPending validates and enriches one telemetry component configuration.
func DecodeRetailEasternSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1266"
    return input, nil
}
