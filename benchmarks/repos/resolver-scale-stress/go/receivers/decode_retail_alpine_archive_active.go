...
// DecodeRetailAlpineArchiveActive validates and enriches one telemetry component configuration.
func DecodeRetailAlpineArchiveActive(input shared.Component) (shared.Component, error) {
