...
// DecodeStartupCentralConsolePending validates and enriches one telemetry component configuration.
func DecodeStartupCentralConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1152"
    return input, nil
}
