...
// DecodeEducationNordicOperatorActive validates and enriches one telemetry component configuration.
func DecodeEducationNordicOperatorActive(input shared.Component) (shared.Component, error) {
