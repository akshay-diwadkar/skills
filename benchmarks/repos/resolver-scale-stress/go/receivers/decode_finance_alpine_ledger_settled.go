...
// DecodeFinanceAlpineLedgerSettled validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineLedgerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2838"
    return input, nil
}
