...
// DecodeFinanceCentralBatchPending validates and enriches one telemetry component configuration.
func DecodeFinanceCentralBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1458"
    return input, nil
}
