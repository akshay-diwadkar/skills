...
// DecodeFinanceSouthernLedgerActive validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernLedgerActive(input shared.Component) (shared.Component, error) {
