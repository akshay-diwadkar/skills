...
// DecodeFinanceNorthernArchivePending validates and enriches one telemetry component configuration.
func DecodeFinanceNorthernArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1998"
    return input, nil
}
