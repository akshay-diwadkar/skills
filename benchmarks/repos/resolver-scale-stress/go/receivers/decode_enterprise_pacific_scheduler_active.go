...
// DecodeEnterprisePacificSchedulerActive validates and enriches one telemetry component configuration.
func DecodeEnterprisePacificSchedulerActive(input shared.Component) (shared.Component, error) {
