...
// DecodeFinanceWesternSchedulerPending validates and enriches one telemetry component configuration.
func DecodeFinanceWesternSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1278"
    return input, nil
}
