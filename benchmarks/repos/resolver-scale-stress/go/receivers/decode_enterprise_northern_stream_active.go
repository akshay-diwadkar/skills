...
// DecodeEnterpriseNorthernStreamActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseNorthernStreamActive(input shared.Component) (shared.Component, error) {
