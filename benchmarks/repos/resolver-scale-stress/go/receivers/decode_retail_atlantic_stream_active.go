...
// DecodeRetailAtlanticStreamActive validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticStreamActive(input shared.Component) (shared.Component, error) {
