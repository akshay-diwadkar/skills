...
// DecodeFinanceCentralOperatorSettled validates and enriches one telemetry component configuration.
func DecodeFinanceCentralOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2658"
    return input, nil
}
