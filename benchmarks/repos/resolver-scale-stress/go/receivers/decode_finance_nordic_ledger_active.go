...
// DecodeFinanceNordicLedgerActive validates and enriches one telemetry component configuration.
func DecodeFinanceNordicLedgerActive(input shared.Component) (shared.Component, error) {
