...
// DecodeFinanceSouthernWebhookActive validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernWebhookActive(input shared.Component) (shared.Component, error) {
