...
// DecodeRetailWesternArchiveSettled validates and enriches one telemetry component configuration.
func DecodeRetailWesternArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2976"
    return input, nil
}
