...
// DecodeEnterpriseAlpineArchiveActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAlpineArchiveActive(input shared.Component) (shared.Component, error) {
