...
// DecodeStartupPacificConsoleSettled validates and enriches one telemetry component configuration.
func DecodeStartupPacificConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2112"
    return input, nil
}
