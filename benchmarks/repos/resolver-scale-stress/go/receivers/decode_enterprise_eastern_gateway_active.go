...
// DecodeEnterpriseEasternGatewayActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseEasternGatewayActive(input shared.Component) (shared.Component, error) {
