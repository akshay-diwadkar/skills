...
// DecodeFinanceAtlanticStreamPending validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1308"
    return input, nil
}
