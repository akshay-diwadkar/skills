...
// DecodeEducationAtlanticConsolePending validates and enriches one telemetry component configuration.
func DecodeEducationAtlanticConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1104"
    return input, nil
}
