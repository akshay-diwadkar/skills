...
// DecodeEducationCoastalGatewayPending validates and enriches one telemetry component configuration.
func DecodeEducationCoastalGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1044"
    return input, nil
}
