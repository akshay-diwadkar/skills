...
// DecodeFinanceNorthernBatchActive validates and enriches one telemetry component configuration.
func DecodeFinanceNorthernBatchActive(input shared.Component) (shared.Component, error) {
