...
// DecodeEnterpriseSouthernStreamPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseSouthernStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1380"
    return input, nil
}
