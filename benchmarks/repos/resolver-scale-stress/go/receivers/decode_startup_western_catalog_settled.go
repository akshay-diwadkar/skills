...
// DecodeStartupWesternCatalogSettled validates and enriches one telemetry component configuration.
func DecodeStartupWesternCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2772"
    return input, nil
}
