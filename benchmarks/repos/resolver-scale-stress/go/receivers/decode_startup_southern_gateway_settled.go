...
// DecodeStartupSouthernGatewaySettled validates and enriches one telemetry component configuration.
func DecodeStartupSouthernGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2082"
    return input, nil
}
