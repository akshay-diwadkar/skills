...
// DecodeFinanceCoastalBatchSettled validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2448"
    return input, nil
}
