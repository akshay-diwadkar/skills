...
// DecodeRetailCoastalStreamSettled validates and enriches one telemetry component configuration.
func DecodeRetailCoastalStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2346"
    return input, nil
}
