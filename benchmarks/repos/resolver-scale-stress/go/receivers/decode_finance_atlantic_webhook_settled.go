...
// DecodeFinanceAtlanticWebhookSettled validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2508"
    return input, nil
}
