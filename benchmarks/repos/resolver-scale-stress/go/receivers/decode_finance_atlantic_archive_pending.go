...
// DecodeFinanceAtlanticArchivePending validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1908"
    return input, nil
}
