...
// DecodeRetailNorthernCatalogSettled validates and enriches one telemetry component configuration.
func DecodeRetailNorthernCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2796"
    return input, nil
}
