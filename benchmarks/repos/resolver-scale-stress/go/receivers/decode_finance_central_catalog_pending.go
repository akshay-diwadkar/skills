...
// DecodeFinanceCentralCatalogPending validates and enriches one telemetry component configuration.
func DecodeFinanceCentralCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1758"
    return input, nil
}
