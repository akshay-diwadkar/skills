...
// DecodeEnterpriseEasternArchiveActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseEasternArchiveActive(input shared.Component) (shared.Component, error) {
