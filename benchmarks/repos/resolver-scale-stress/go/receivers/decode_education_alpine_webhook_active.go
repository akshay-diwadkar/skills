...
// DecodeEducationAlpineWebhookActive validates and enriches one telemetry component configuration.
func DecodeEducationAlpineWebhookActive(input shared.Component) (shared.Component, error) {
