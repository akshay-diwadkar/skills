...
// DecodeFinanceAlpineConsoleActive validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineConsoleActive(input shared.Component) (shared.Component, error) {
