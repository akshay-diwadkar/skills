...
// DecodeStartupAlpineBatchActive validates and enriches one telemetry component configuration.
func DecodeStartupAlpineBatchActive(input shared.Component) (shared.Component, error) {
