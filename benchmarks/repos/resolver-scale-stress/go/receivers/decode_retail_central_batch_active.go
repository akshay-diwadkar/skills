...
// DecodeRetailCentralBatchActive validates and enriches one telemetry component configuration.
func DecodeRetailCentralBatchActive(input shared.Component) (shared.Component, error) {
