...
// DecodeEnterpriseSouthernGatewayPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseSouthernGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1080"
    return input, nil
}
