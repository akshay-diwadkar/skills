...
// DecodeStartupCoastalSchedulerPending validates and enriches one telemetry component configuration.
func DecodeStartupCoastalSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1242"
    return input, nil
}
