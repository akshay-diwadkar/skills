...
// DecodeFinanceWesternStreamActive validates and enriches one telemetry component configuration.
func DecodeFinanceWesternStreamActive(input shared.Component) (shared.Component, error) {
