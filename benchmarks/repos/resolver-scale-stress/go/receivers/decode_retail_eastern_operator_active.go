...
// DecodeRetailEasternOperatorActive validates and enriches one telemetry component configuration.
func DecodeRetailEasternOperatorActive(input shared.Component) (shared.Component, error) {
