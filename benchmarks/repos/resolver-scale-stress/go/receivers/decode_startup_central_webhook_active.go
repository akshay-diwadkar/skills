...
// DecodeStartupCentralWebhookActive validates and enriches one telemetry component configuration.
func DecodeStartupCentralWebhookActive(input shared.Component) (shared.Component, error) {
