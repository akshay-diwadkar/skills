...
// DecodeFinanceWesternConsoleSettled validates and enriches one telemetry component configuration.
func DecodeFinanceWesternConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2178"
    return input, nil
}
