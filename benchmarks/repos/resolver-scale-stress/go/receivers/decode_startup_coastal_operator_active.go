...
// DecodeStartupCoastalOperatorActive validates and enriches one telemetry component configuration.
func DecodeStartupCoastalOperatorActive(input shared.Component) (shared.Component, error) {
