...
// DecodeRetailEasternStreamActive validates and enriches one telemetry component configuration.
func DecodeRetailEasternStreamActive(input shared.Component) (shared.Component, error) {
