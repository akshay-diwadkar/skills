...
// DecodeEducationNordicGatewayActive validates and enriches one telemetry component configuration.
func DecodeEducationNordicGatewayActive(input shared.Component) (shared.Component, error) {
