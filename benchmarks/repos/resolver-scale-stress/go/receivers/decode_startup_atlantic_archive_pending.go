...
// DecodeStartupAtlanticArchivePending validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1902"
    return input, nil
}
