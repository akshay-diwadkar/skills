...
// DecodeEducationSouthernOperatorActive validates and enriches one telemetry component configuration.
func DecodeEducationSouthernOperatorActive(input shared.Component) (shared.Component, error) {
