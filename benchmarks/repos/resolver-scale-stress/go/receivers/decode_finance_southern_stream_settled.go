...
// DecodeFinanceSouthernStreamSettled validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2388"
    return input, nil
}
