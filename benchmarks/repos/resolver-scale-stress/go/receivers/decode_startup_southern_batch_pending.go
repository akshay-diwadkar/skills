...
// DecodeStartupSouthernBatchPending validates and enriches one telemetry component configuration.
func DecodeStartupSouthernBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1482"
    return input, nil
}
