...
// DecodeFinanceNordicConsolePending validates and enriches one telemetry component configuration.
func DecodeFinanceNordicConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1128"
    return input, nil
}
