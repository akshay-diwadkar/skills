...
// DecodeEnterprisePacificArchiveSettled validates and enriches one telemetry component configuration.
func DecodeEnterprisePacificArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2910"
    return input, nil
}
