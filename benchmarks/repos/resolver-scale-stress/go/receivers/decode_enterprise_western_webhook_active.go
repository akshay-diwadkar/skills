...
// DecodeEnterpriseWesternWebhookActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternWebhookActive(input shared.Component) (shared.Component, error) {
