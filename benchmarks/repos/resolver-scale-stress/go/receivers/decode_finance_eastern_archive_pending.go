...
// DecodeFinanceEasternArchivePending validates and enriches one telemetry component configuration.
func DecodeFinanceEasternArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1968"
    return input, nil
}
