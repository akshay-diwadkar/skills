...
// DecodeEducationCentralArchiveActive validates and enriches one telemetry component configuration.
func DecodeEducationCentralArchiveActive(input shared.Component) (shared.Component, error) {
