...
// DecodeRetailNordicSchedulerSettled validates and enriches one telemetry component configuration.
func DecodeRetailNordicSchedulerSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2226"
    return input, nil
}
