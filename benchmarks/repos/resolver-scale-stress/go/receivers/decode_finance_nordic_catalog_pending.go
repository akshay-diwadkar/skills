...
// DecodeFinanceNordicCatalogPending validates and enriches one telemetry component configuration.
func DecodeFinanceNordicCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1728"
    return input, nil
}
