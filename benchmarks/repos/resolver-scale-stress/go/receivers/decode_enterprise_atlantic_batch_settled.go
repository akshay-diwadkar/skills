...
// DecodeEnterpriseAtlanticBatchSettled validates and enriches one telemetry component configuration.
func DecodeEnterpriseAtlanticBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2400"
    return input, nil
}
