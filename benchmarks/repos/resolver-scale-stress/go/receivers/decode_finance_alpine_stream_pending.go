...
// DecodeFinanceAlpineStreamPending validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1338"
    return input, nil
}
