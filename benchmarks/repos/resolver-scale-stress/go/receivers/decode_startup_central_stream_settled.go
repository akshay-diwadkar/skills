...
// DecodeStartupCentralStreamSettled validates and enriches one telemetry component configuration.
func DecodeStartupCentralStreamSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2352"
    return input, nil
}
