...
// DecodeStartupSouthernSchedulerActive validates and enriches one telemetry component configuration.
func DecodeStartupSouthernSchedulerActive(input shared.Component) (shared.Component, error) {
