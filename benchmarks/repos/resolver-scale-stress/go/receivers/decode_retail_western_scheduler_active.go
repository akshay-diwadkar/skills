...
// DecodeRetailWesternSchedulerActive validates and enriches one telemetry component configuration.
func DecodeRetailWesternSchedulerActive(input shared.Component) (shared.Component, error) {
