...
// DecodeRetailSouthernConsoleActive validates and enriches one telemetry component configuration.
func DecodeRetailSouthernConsoleActive(input shared.Component) (shared.Component, error) {
