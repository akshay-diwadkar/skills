...
// DecodeStartupCoastalArchiveActive validates and enriches one telemetry component configuration.
func DecodeStartupCoastalArchiveActive(input shared.Component) (shared.Component, error) {
