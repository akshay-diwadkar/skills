...
// DecodeStartupEasternArchivePending validates and enriches one telemetry component configuration.
func DecodeStartupEasternArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1962"
    return input, nil
}
