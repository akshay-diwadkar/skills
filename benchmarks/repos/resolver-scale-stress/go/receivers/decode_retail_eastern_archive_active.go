...
// DecodeRetailEasternArchiveActive validates and enriches one telemetry component configuration.
func DecodeRetailEasternArchiveActive(input shared.Component) (shared.Component, error) {
