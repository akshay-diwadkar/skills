...
// DecodeRetailCentralArchivePending validates and enriches one telemetry component configuration.
func DecodeRetailCentralArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1956"
    return input, nil
}
