...
// DecodeFinanceSouthernConsolePending validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1188"
    return input, nil
}
