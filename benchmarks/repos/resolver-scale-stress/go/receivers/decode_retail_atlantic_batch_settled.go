...
// DecodeRetailAtlanticBatchSettled validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2406"
    return input, nil
}
