...
// DecodeFinanceAtlanticGatewayPending validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1008"
    return input, nil
}
