...
// DecodeFinanceNordicWebhookActive validates and enriches one telemetry component configuration.
func DecodeFinanceNordicWebhookActive(input shared.Component) (shared.Component, error) {
