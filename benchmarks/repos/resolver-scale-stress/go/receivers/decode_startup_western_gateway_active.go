...
// DecodeStartupWesternGatewayActive validates and enriches one telemetry component configuration.
func DecodeStartupWesternGatewayActive(input shared.Component) (shared.Component, error) {
