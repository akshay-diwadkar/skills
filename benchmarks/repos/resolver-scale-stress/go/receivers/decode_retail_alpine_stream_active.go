...
// DecodeRetailAlpineStreamActive validates and enriches one telemetry component configuration.
func DecodeRetailAlpineStreamActive(input shared.Component) (shared.Component, error) {
