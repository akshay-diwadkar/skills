...
// DecodeStartupAtlanticConsoleActive validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticConsoleActive(input shared.Component) (shared.Component, error) {
