...
// DecodeEnterpriseAtlanticWebhookPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseAtlanticWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1500"
    return input, nil
}
