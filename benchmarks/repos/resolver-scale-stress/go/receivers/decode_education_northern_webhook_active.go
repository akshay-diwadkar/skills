...
// DecodeEducationNorthernWebhookActive validates and enriches one telemetry component configuration.
func DecodeEducationNorthernWebhookActive(input shared.Component) (shared.Component, error) {
