...
// DecodeEnterpriseNorthernSchedulerPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseNorthernSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1290"
    return input, nil
}
