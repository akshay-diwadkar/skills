...
// DecodeEducationNorthernOperatorSettled validates and enriches one telemetry component configuration.
func DecodeEducationNorthernOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2694"
    return input, nil
}
