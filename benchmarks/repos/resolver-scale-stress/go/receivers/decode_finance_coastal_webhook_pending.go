...
// DecodeFinanceCoastalWebhookPending validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1548"
    return input, nil
}
