...
// DecodeEducationEasternLedgerActive validates and enriches one telemetry component configuration.
func DecodeEducationEasternLedgerActive(input shared.Component) (shared.Component, error) {
