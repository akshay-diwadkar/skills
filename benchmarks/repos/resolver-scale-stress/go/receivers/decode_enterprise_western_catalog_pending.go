...
// DecodeEnterpriseWesternCatalogPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1770"
    return input, nil
}
