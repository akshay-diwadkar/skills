...
// DecodeStartupNorthernArchivePending validates and enriches one telemetry component configuration.
func DecodeStartupNorthernArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1992"
    return input, nil
}
