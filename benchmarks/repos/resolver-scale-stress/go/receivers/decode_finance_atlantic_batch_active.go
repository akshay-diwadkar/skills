...
// DecodeFinanceAtlanticBatchActive validates and enriches one telemetry component configuration.
func DecodeFinanceAtlanticBatchActive(input shared.Component) (shared.Component, error) {
