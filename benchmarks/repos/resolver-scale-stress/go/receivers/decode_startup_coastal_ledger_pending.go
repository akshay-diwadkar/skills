...
// DecodeStartupCoastalLedgerPending validates and enriches one telemetry component configuration.
func DecodeStartupCoastalLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1842"
    return input, nil
}
