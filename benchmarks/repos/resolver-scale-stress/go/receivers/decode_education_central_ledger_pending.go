...
// DecodeEducationCentralLedgerPending validates and enriches one telemetry component configuration.
func DecodeEducationCentralLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1854"
    return input, nil
}
