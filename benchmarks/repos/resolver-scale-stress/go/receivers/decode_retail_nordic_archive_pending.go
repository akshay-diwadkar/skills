...
// DecodeRetailNordicArchivePending validates and enriches one telemetry component configuration.
func DecodeRetailNordicArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1926"
    return input, nil
}
