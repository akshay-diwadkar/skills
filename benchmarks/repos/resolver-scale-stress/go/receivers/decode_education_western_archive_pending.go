...
// DecodeEducationWesternArchivePending validates and enriches one telemetry component configuration.
func DecodeEducationWesternArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1974"
    return input, nil
}
