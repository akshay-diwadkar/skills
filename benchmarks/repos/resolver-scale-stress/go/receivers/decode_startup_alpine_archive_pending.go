...
// DecodeStartupAlpineArchivePending validates and enriches one telemetry component configuration.
func DecodeStartupAlpineArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1932"
    return input, nil
}
