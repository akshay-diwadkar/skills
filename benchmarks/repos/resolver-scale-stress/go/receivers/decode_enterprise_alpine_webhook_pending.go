...
// DecodeEnterpriseAlpineWebhookPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseAlpineWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1530"
    return input, nil
}
