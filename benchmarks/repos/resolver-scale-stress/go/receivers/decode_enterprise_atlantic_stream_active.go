...
// DecodeEnterpriseAtlanticStreamActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAtlanticStreamActive(input shared.Component) (shared.Component, error) {
