...
// DecodeEnterpriseAtlanticGatewayActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAtlanticGatewayActive(input shared.Component) (shared.Component, error) {
