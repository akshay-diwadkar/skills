...
// DecodeRetailCoastalOperatorSettled validates and enriches one telemetry component configuration.
func DecodeRetailCoastalOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2646"
    return input, nil
}
