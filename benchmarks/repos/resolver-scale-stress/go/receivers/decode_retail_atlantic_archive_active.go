...
// DecodeRetailAtlanticArchiveActive validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticArchiveActive(input shared.Component) (shared.Component, error) {
