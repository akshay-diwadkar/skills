...
// DecodeStartupNorthernCatalogActive validates and enriches one telemetry component configuration.
func DecodeStartupNorthernCatalogActive(input shared.Component) (shared.Component, error) {
