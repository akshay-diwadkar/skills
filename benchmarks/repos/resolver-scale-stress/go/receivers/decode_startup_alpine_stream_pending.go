...
// DecodeStartupAlpineStreamPending validates and enriches one telemetry component configuration.
func DecodeStartupAlpineStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1332"
    return input, nil
}
