...
// DecodeStartupNordicSchedulerActive validates and enriches one telemetry component configuration.
func DecodeStartupNordicSchedulerActive(input shared.Component) (shared.Component, error) {
