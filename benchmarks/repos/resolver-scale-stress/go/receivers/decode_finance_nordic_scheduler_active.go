...
// DecodeFinanceNordicSchedulerActive validates and enriches one telemetry component configuration.
func DecodeFinanceNordicSchedulerActive(input shared.Component) (shared.Component, error) {
