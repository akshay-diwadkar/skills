...
// DecodeFinanceCoastalGatewayActive validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalGatewayActive(input shared.Component) (shared.Component, error) {
