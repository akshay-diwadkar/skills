...
// DecodeEnterpriseNorthernArchiveActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseNorthernArchiveActive(input shared.Component) (shared.Component, error) {
