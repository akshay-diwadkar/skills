...
// DecodeFinanceCentralWebhookActive validates and enriches one telemetry component configuration.
func DecodeFinanceCentralWebhookActive(input shared.Component) (shared.Component, error) {
