...
// DecodeEnterpriseCentralCatalogActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseCentralCatalogActive(input shared.Component) (shared.Component, error) {
