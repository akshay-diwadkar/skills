...
// DecodeFinanceCoastalSchedulerPending validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1248"
    return input, nil
}
