...
// DecodeEnterpriseAtlanticOperatorActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAtlanticOperatorActive(input shared.Component) (shared.Component, error) {
