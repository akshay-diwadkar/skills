...
// DecodeStartupEasternGatewayPending validates and enriches one telemetry component configuration.
func DecodeStartupEasternGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1062"
    return input, nil
}
