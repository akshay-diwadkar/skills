...
// DecodeEducationNordicStreamActive validates and enriches one telemetry component configuration.
func DecodeEducationNordicStreamActive(input shared.Component) (shared.Component, error) {
