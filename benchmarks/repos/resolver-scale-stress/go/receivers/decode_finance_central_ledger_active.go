...
// DecodeFinanceCentralLedgerActive validates and enriches one telemetry component configuration.
func DecodeFinanceCentralLedgerActive(input shared.Component) (shared.Component, error) {
