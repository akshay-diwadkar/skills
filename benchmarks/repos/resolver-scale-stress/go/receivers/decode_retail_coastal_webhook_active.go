...
// DecodeRetailCoastalWebhookActive validates and enriches one telemetry component configuration.
func DecodeRetailCoastalWebhookActive(input shared.Component) (shared.Component, error) {
