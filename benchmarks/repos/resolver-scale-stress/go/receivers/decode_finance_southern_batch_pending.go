...
// DecodeFinanceSouthernBatchPending validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1488"
    return input, nil
}
