...
// DecodeFinanceCentralGatewaySettled validates and enriches one telemetry component configuration.
func DecodeFinanceCentralGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2058"
    return input, nil
}
