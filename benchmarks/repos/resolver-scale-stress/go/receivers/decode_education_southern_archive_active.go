...
// DecodeEducationSouthernArchiveActive validates and enriches one telemetry component configuration.
func DecodeEducationSouthernArchiveActive(input shared.Component) (shared.Component, error) {
