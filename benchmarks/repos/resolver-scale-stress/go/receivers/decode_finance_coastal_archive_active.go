...
// DecodeFinanceCoastalArchiveActive validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalArchiveActive(input shared.Component) (shared.Component, error) {
