...
// DecodeFinanceSouthernGatewaySettled validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2088"
    return input, nil
}
