...
// DecodeStartupAtlanticOperatorPending validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticOperatorPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1602"
    return input, nil
}
