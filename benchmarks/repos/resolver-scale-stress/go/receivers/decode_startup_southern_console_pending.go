...
// DecodeStartupSouthernConsolePending validates and enriches one telemetry component configuration.
func DecodeStartupSouthernConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1182"
    return input, nil
}
