...
// DecodeRetailNorthernBatchSettled validates and enriches one telemetry component configuration.
func DecodeRetailNorthernBatchSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2496"
    return input, nil
}
