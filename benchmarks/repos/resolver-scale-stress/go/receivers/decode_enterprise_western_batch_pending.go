...
// DecodeEnterpriseWesternBatchPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1470"
    return input, nil
}
