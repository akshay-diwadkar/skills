...
// DecodeEnterpriseSouthernArchivePending validates and enriches one telemetry component configuration.
func DecodeEnterpriseSouthernArchivePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1980"
    return input, nil
}
