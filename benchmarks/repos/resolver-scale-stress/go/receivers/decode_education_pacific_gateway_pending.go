...
// DecodeEducationPacificGatewayPending validates and enriches one telemetry component configuration.
func DecodeEducationPacificGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1014"
    return input, nil
}
