...
// DecodeFinancePacificStreamActive validates and enriches one telemetry component configuration.
func DecodeFinancePacificStreamActive(input shared.Component) (shared.Component, error) {
