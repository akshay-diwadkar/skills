...
// DecodeEnterpriseAtlanticArchiveActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAtlanticArchiveActive(input shared.Component) (shared.Component, error) {
