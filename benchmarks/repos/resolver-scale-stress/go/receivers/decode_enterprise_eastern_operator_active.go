...
// DecodeEnterpriseEasternOperatorActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseEasternOperatorActive(input shared.Component) (shared.Component, error) {
