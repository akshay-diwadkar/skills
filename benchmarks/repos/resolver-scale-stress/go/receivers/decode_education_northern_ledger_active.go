...
// DecodeEducationNorthernLedgerActive validates and enriches one telemetry component configuration.
func DecodeEducationNorthernLedgerActive(input shared.Component) (shared.Component, error) {
