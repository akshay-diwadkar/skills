...
// DecodeRetailNordicWebhookSettled validates and enriches one telemetry component configuration.
func DecodeRetailNordicWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2526"
    return input, nil
}
