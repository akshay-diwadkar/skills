...
// DecodeEducationCentralGatewayActive validates and enriches one telemetry component configuration.
func DecodeEducationCentralGatewayActive(input shared.Component) (shared.Component, error) {
