...
// DecodeEducationNordicSchedulerPending validates and enriches one telemetry component configuration.
func DecodeEducationNordicSchedulerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1224"
    return input, nil
}
