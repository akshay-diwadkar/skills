...
// DecodeEducationWesternBatchActive validates and enriches one telemetry component configuration.
func DecodeEducationWesternBatchActive(input shared.Component) (shared.Component, error) {
