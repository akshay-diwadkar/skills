...
// DecodeStartupPacificStreamActive validates and enriches one telemetry component configuration.
func DecodeStartupPacificStreamActive(input shared.Component) (shared.Component, error) {
