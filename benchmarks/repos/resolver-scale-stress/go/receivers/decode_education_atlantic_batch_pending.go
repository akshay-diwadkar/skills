...
// DecodeEducationAtlanticBatchPending validates and enriches one telemetry component configuration.
func DecodeEducationAtlanticBatchPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1404"
    return input, nil
}
