...
// DecodeEducationAtlanticWebhookActive validates and enriches one telemetry component configuration.
func DecodeEducationAtlanticWebhookActive(input shared.Component) (shared.Component, error) {
