...
// DecodeRetailAtlanticOperatorActive validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticOperatorActive(input shared.Component) (shared.Component, error) {
