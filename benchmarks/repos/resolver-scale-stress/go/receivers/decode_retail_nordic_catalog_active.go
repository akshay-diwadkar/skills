...
// DecodeRetailNordicCatalogActive validates and enriches one telemetry component configuration.
func DecodeRetailNordicCatalogActive(input shared.Component) (shared.Component, error) {
