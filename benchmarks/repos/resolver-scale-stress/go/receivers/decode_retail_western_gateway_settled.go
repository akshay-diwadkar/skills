...
// DecodeRetailWesternGatewaySettled validates and enriches one telemetry component configuration.
func DecodeRetailWesternGatewaySettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2076"
    return input, nil
}
