...
// DecodeRetailAtlanticConsoleSettled validates and enriches one telemetry component configuration.
func DecodeRetailAtlanticConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2106"
    return input, nil
}
