...
// DecodeEnterpriseCentralStreamPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseCentralStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1350"
    return input, nil
}
