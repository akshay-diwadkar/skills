...
// DecodeFinanceSouthernArchiveSettled validates and enriches one telemetry component configuration.
func DecodeFinanceSouthernArchiveSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2988"
    return input, nil
}
