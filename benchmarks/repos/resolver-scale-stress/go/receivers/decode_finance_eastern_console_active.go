...
// DecodeFinanceEasternConsoleActive validates and enriches one telemetry component configuration.
func DecodeFinanceEasternConsoleActive(input shared.Component) (shared.Component, error) {
