...
// DecodeRetailCoastalSchedulerActive validates and enriches one telemetry component configuration.
func DecodeRetailCoastalSchedulerActive(input shared.Component) (shared.Component, error) {
