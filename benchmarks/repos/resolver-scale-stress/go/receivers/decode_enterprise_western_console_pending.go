...
// DecodeEnterpriseWesternConsolePending validates and enriches one telemetry component configuration.
func DecodeEnterpriseWesternConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1170"
    return input, nil
}
