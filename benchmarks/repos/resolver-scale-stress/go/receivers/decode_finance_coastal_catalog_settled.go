...
// DecodeFinanceCoastalCatalogSettled validates and enriches one telemetry component configuration.
func DecodeFinanceCoastalCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2748"
    return input, nil
}
