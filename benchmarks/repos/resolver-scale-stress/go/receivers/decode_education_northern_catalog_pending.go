...
// DecodeEducationNorthernCatalogPending validates and enriches one telemetry component configuration.
func DecodeEducationNorthernCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1794"
    return input, nil
}
