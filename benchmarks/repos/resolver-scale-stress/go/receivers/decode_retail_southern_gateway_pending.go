...
// DecodeRetailSouthernGatewayPending validates and enriches one telemetry component configuration.
func DecodeRetailSouthernGatewayPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1086"
    return input, nil
}
