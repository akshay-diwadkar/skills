...
// DecodeStartupAtlanticBatchActive validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticBatchActive(input shared.Component) (shared.Component, error) {
