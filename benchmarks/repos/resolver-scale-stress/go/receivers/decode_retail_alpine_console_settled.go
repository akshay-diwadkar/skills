...
// DecodeRetailAlpineConsoleSettled validates and enriches one telemetry component configuration.
func DecodeRetailAlpineConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2136"
    return input, nil
}
