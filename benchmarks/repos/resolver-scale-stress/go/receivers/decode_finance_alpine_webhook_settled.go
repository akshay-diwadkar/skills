...
// DecodeFinanceAlpineWebhookSettled validates and enriches one telemetry component configuration.
func DecodeFinanceAlpineWebhookSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2538"
    return input, nil
}
