...
// DecodeEnterpriseAlpineLedgerPending validates and enriches one telemetry component configuration.
func DecodeEnterpriseAlpineLedgerPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1830"
    return input, nil
}
