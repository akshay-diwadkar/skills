...
// DecodeEducationEasternConsolePending validates and enriches one telemetry component configuration.
func DecodeEducationEasternConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1164"
    return input, nil
}
