...
// DecodeRetailWesternOperatorSettled validates and enriches one telemetry component configuration.
func DecodeRetailWesternOperatorSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2676"
    return input, nil
}
