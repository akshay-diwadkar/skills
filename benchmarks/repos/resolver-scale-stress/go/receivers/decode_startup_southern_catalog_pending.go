...
// DecodeStartupSouthernCatalogPending validates and enriches one telemetry component configuration.
func DecodeStartupSouthernCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1782"
    return input, nil
}
