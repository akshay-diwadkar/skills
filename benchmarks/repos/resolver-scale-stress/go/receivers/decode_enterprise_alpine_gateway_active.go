...
// DecodeEnterpriseAlpineGatewayActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseAlpineGatewayActive(input shared.Component) (shared.Component, error) {
