...
// DecodeStartupSouthernLedgerActive validates and enriches one telemetry component configuration.
func DecodeStartupSouthernLedgerActive(input shared.Component) (shared.Component, error) {
