...
// DecodeRetailNorthernConsoleSettled validates and enriches one telemetry component configuration.
func DecodeRetailNorthernConsoleSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2196"
    return input, nil
}
