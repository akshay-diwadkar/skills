...
// DecodeEnterpriseCoastalLedgerActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseCoastalLedgerActive(input shared.Component) (shared.Component, error) {
