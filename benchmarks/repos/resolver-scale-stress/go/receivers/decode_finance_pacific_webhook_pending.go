...
// DecodeFinancePacificWebhookPending validates and enriches one telemetry component configuration.
func DecodeFinancePacificWebhookPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1518"
    return input, nil
}
