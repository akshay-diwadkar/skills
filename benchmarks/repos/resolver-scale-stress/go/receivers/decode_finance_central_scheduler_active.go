...
// DecodeFinanceCentralSchedulerActive validates and enriches one telemetry component configuration.
func DecodeFinanceCentralSchedulerActive(input shared.Component) (shared.Component, error) {
