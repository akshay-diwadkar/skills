...
// DecodeStartupAlpineCatalogActive validates and enriches one telemetry component configuration.
func DecodeStartupAlpineCatalogActive(input shared.Component) (shared.Component, error) {
