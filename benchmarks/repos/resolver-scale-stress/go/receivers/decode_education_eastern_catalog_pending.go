...
// DecodeEducationEasternCatalogPending validates and enriches one telemetry component configuration.
func DecodeEducationEasternCatalogPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1764"
    return input, nil
}
