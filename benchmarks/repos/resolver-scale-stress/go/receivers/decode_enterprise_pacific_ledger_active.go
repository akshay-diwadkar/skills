...
// DecodeEnterprisePacificLedgerActive validates and enriches one telemetry component configuration.
func DecodeEnterprisePacificLedgerActive(input shared.Component) (shared.Component, error) {
