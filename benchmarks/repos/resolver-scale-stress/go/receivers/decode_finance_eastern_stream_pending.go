...
// DecodeFinanceEasternStreamPending validates and enriches one telemetry component configuration.
func DecodeFinanceEasternStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1368"
    return input, nil
}
