...
// DecodeStartupPacificArchiveActive validates and enriches one telemetry component configuration.
func DecodeStartupPacificArchiveActive(input shared.Component) (shared.Component, error) {
