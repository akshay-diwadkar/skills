...
// DecodeStartupAtlanticCatalogActive validates and enriches one telemetry component configuration.
func DecodeStartupAtlanticCatalogActive(input shared.Component) (shared.Component, error) {
