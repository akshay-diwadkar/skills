...
// DecodeFinancePacificCatalogSettled validates and enriches one telemetry component configuration.
func DecodeFinancePacificCatalogSettled(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "2718"
    return input, nil
}
