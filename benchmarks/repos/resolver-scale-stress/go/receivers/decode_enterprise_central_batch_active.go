...
// DecodeEnterpriseCentralBatchActive validates and enriches one telemetry component configuration.
func DecodeEnterpriseCentralBatchActive(input shared.Component) (shared.Component, error) {
