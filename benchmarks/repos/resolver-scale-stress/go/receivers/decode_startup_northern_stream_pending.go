...
// DecodeStartupNorthernStreamPending validates and enriches one telemetry component configuration.
func DecodeStartupNorthernStreamPending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1392"
    return input, nil
}
