...
// DecodeRetailEasternGatewayActive validates and enriches one telemetry component configuration.
func DecodeRetailEasternGatewayActive(input shared.Component) (shared.Component, error) {
