...
// DecodeStartupCentralSchedulerActive validates and enriches one telemetry component configuration.
func DecodeStartupCentralSchedulerActive(input shared.Component) (shared.Component, error) {
