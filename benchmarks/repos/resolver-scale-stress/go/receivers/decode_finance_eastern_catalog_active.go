...
// DecodeFinanceEasternCatalogActive validates and enriches one telemetry component configuration.
func DecodeFinanceEasternCatalogActive(input shared.Component) (shared.Component, error) {
