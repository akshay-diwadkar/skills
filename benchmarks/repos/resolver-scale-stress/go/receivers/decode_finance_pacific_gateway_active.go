...
// DecodeFinancePacificGatewayActive validates and enriches one telemetry component configuration.
func DecodeFinancePacificGatewayActive(input shared.Component) (shared.Component, error) {
