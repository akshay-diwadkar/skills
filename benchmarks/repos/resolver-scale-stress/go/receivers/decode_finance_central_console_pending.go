...
// DecodeFinanceCentralConsolePending validates and enriches one telemetry component configuration.
func DecodeFinanceCentralConsolePending(input shared.Component) (shared.Component, error) {
    ...
    input.Attributes["revision"] = "1158"
    return input, nil
}
