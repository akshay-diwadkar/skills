...
// DecodeEducationWesternConsoleActive validates and enriches one telemetry component configuration.
func DecodeEducationWesternConsoleActive(input shared.Component) (shared.Component, error) {
