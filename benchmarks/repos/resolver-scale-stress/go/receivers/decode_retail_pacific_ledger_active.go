...
// DecodeRetailPacificLedgerActive validates and enriches one telemetry component configuration.
func DecodeRetailPacificLedgerActive(input shared.Component) (shared.Component, error) {
