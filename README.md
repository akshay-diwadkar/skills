...
| [build-codebase-knowledge](docs/skills/build-codebase-knowledge.md) | `engineering` | `utility` | `stable` | `both` | Generate compact repository-navigation artifacts and resolve coding tasks into bounded, evidence-backed read phases. |
